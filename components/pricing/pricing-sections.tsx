...
const COPY = {
  fr: {
    ...
    lead: 'Vous payez son identité professionnelle, son environnement privé et son expérience. Après l’essai, vous choisissez les modèles qu’il mobilise et leur mode de règlement.',
  ...
  en: {
    ...
    lead: 'You pay for its professional identity, private environment and experience. After the trial, you choose the models it uses and how to pay for them.',
