...
const COPY = {
  fr: {
    ...
    primary: 'Démarrer avec Alma', exploreMissions: 'Explorer les missions', priceAnchor: 'Workspace Solo gratuit. Chaque Collaborateur IA : 49 €/mois.',
    ...
    selectedProfile: 'Profil de départ', summaryTitle: 'Calcul du prix', summaryBody: 'Votre total se met à jour selon la taille du Workspace et le nombre de Collaborateurs IA.', workspaceLine: 'Licence Workspace', collaboratorsLine: 'Collaborateurs IA', tokensLine: 'Modèle DeepSeek hébergé en Europe', includedTokens: '5 millions de tokens/mois inclus', millionTokens: 'millions de tokens/mois inclus', phoneLine: 'Téléphone inclus', phoneMinutes: '60 min par Collaborateur IA/mois', freeCreditsLine: 'Crédits Workspace inclus', setupLine: 'Mise en service', setupValue: 'Accompagnée par Alma', monthly: 'Total mensuel', today: 'À payer aujourd’hui',
    usageKicker: 'Consommation IA', usageTitle: 'Un mode adapté à chaque usage.', usageLead: 'Le Workspace inclut des crédits pour vos assistants privés ou partagés. Chaque Collaborateur IA inclut DeepSeek V4 Flash. Pour les autres modèles, utilisez des crédits prépayés ou vos propres clés API.',
    creditsTitle: 'Autres modèles · Crédits IA', creditsBody: 'Utilisez les crédits inclus dans votre Workspace, puis rechargez à partir de 25 € selon vos besoins.', creditsCta: 'Acheter des crédits', creditsDetail: 'Voir le détail',
    ...
    migrationKicker: 'Déjà équipé ?', migrationTitle: 'Migrez votre agent Hermes ou OpenClaw vers Unitalk.', migrationBody: 'Commandez la reprise de votre configuration, de vos outils et de vos données exportables. Unitalk permet de déployer des agents open source autonomes à l’échelle de l’entreprise.', migrationCta: 'Commander la migration',
    continue: 'Continuer avec cette configuration', activationNote: '0 € aujourd’hui. Aucun abonnement ne démarre sans votre confirmation.', error: 'La configuration n’a pas pu être enregistrée. Réessayez.',
  ...
  en: {
    ...
    primary: 'Start with Alma', exploreMissions: 'Explore missions', priceAnchor: 'Free Solo Workspace. Each AI Collaborator: €49/month.',
    ...
    selectedProfile: 'Starting profile', summaryTitle: 'Price calculation', summaryBody: 'Your total updates with the Workspace size and number of AI Collaborators.', workspaceLine: 'Workspace license', collaboratorsLine: 'AI Collaborators', tokensLine: 'DeepSeek model hosted in Europe', includedTokens: '5 million tokens/month included', millionTokens: 'million tokens/month included', phoneLine: 'Included phone usage', phoneMinutes: '60 min per AI Collaborator/month', freeCreditsLine: 'Included Workspace credits', setupLine: 'Setup', setupValue: 'Guided by Alma', monthly: 'Monthly total', today: 'Due today',
    usageKicker: 'AI usage', usageTitle: 'A mode for every use case.', usageLead: 'The Workspace includes credits for private or shared assistants. Each AI Collaborator includes DeepSeek V4 Flash. For other models, use prepaid credits or your own API keys.',
    creditsTitle: 'Other models · AI credits', creditsBody: 'Use the credits included with your Workspace, then top up from €25 whenever needed.', creditsCta: 'Buy credits', creditsDetail: 'View details',
    ...
    migrationKicker: 'Already equipped?', migrationTitle: 'Move your Hermes or OpenClaw agent to Unitalk.', migrationBody: 'Order the transfer of your configuration, tools and exportable data. Unitalk lets you deploy autonomous open-source agents across your organization.', migrationCta: 'Order migration',
    continue: 'Continue with this configuration', activationNote: '€0 today. No subscription starts without your confirmation.', error: 'We could not save this configuration. Please try again.',
  ...
  return (
    <section className="relative overflow-hidden border-b border-[#D8CEBE] bg-[#EAE3D4] px-5 pb-8 pt-24 sm:px-8 sm:pb-10 sm:pt-28">
      ...
      <div className="editorial-shell relative grid gap-6 lg:grid-cols-[1fr_.9fr] lg:items-end lg:gap-12">
        ...
        <div><p className="max-w-xl text-[15px] leading-7 text-[#4E483F] sm:text-[16px]">{withAlmaAvatar(t.lead)}</p><p className="mt-4 text-sm font-black text-[#1C1A17]">{t.priceAnchor}</p><div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center"><Link href="/decouvrir?source=tarifs" className="inline-flex min-h-11 items-center justify-center rounded-full bg-[#D10E63] px-6 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-[#B00C54]">{t.primary}<ArrowRight className="ml-2 size-4"/></Link><Link href="/missions" className="inline-flex min-h-11 items-center justify-center px-3 text-sm font-bold text-[#4E483F] underline decoration-[#D10E63]/35 underline-offset-4 hover:text-[#B00C54]">{t.exploreMissions}</Link></div></div>
