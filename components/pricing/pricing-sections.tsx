...
const COPY = {
  fr: {
    ...
    priceKicker: 'Une formule claire, sans frais cachés',
    ...
    selectedProfile: 'Profil de départ', summaryTitle: 'Calcul du prix', summaryBody: 'Votre total se met à jour selon la taille du Workspace et le nombre de Collaborateurs IA.', workspaceLine: 'Licence Workspace', collaboratorsLine: 'Collaborateurs IA', tokensLine: 'DeepSeek V4', includedTokens: '5 millions de tokens inclus', millionTokens: 'millions de tokens inclus', hostingLine: 'Hébergement', hostingValue: 'Europe · Microsoft Azure', phoneLine: 'Téléphone', phoneMinutes: '60 min incluses', freeCreditsLine: 'Crédits IA inclus', setupLine: 'Mise en service', setupValue: 'Accompagnée par Alma', monthly: 'Total mensuel HT', annual: 'Total annuel HT', today: 'À payer aujourd’hui', tax: 'Prix HT',
    usageKicker: 'Consommation IA', usageTitle: 'Ne payez que', usageAccent: 'ce que vous consommez.', usageLead: 'Les crédits IA inclus ou achetés alimentent un solde unique pour toute l’entreprise. Les Collaborateurs humains et IA y puisent selon leurs usages. Vous pouvez aussi connecter vos propres clés API.',
  ...
  en: {
    ...
    priceKicker: 'Clear pricing, no hidden fees',
    ...
    selectedProfile: 'Starting profile', summaryTitle: 'Price calculation', summaryBody: 'Your total updates with the Workspace size and number of AI Collaborators.', workspaceLine: 'Workspace license', collaboratorsLine: 'AI Collaborators', tokensLine: 'DeepSeek V4', includedTokens: '5 million tokens included', millionTokens: 'million tokens included', hostingLine: 'Hosting', hostingValue: 'Europe · Microsoft Azure', phoneLine: 'Phone', phoneMinutes: '60 min included', freeCreditsLine: 'Included AI credits', setupLine: 'Setup', setupValue: 'Guided by Alma', monthly: 'Monthly total excl. tax', annual: 'Annual total excl. tax', today: 'Due today', tax: 'Price excludes tax',
    usageKicker: 'AI usage', usageTitle: 'Pay only for', usageAccent: 'what you use.', usageLead: 'Included or purchased AI credits fund one balance for your entire organization. Human and AI Collaborators draw from it based on their usage. You can also connect your own API keys.',
        ...
        <div className="editorial-shell">
          ...
          <section className="mt-16 border-y border-[#CFC5B5] py-10 sm:py-12">
            <div className="grid gap-8 lg:grid-cols-[.8fr_1.2fr] lg:gap-14">
              <div><Kicker>{t.usageKicker}</Kicker><h2 className="mt-5 max-w-xl text-balance font-sf text-[clamp(2.35rem,5vw,4.8rem)] font-semibold leading-[.94] tracking-[-.06em]">{t.usageTitle}<span className="block text-[#D10E63]">{t.usageAccent}</span></h2><p className="mt-5 max-w-lg text-[15px] leading-7 text-[#625B50]">{t.usageLead}</p><dl className="mt-7 space-y-4 border-l border-[#D10E63]/30 pl-5">{t.usageProofs.map(([title, body]) => <div key={title}><dt className="text-sm font-bold text-[#1C1A17]">{title}</dt><dd className="mt-1 text-xs leading-6 text-[#625B50]">{body}</dd></div>)}</dl></div>
