...
const ITEMS = {
  fr: [
    ...
    ['Que comprend la Licence Workspace Unitalk ?', 'La licence est un forfait par entreprise, jamais par siège : gratuite pour 1 utilisateur, 49 € jusqu’à 10 et 299 € jusqu’à 100. Elle inclut le Workspace Web et Desktop, des Assistants IA illimités, les modèles autorisés, plus de 3 000 intégrations, les droits et les validations. La formule à 49 € inclut 2 500 crédits IA par mois et celle à 299 € en inclut 20 000.'],
    ['Que comprend un Collaborateur IA à 49 € par mois ?', 'Son identité, sa mémoire, ses profils métier et compétences illimités, ses outils de communication et une instance dédiée de l’agent Hermes. Il peut recevoir et passer des appels téléphoniques selon les règles définies par votre entreprise. Chaque Collaborateur inclut 1 million de tokens et 60 minutes de téléphone.'],
