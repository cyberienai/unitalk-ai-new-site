...
const T = {
  fr: {
    ...
    platformOptions: ['OpenClaw', 'Hermes', 'ChatGPT Team', 'Claude', 'Gemini Spark', 'Microsoft Scout', 'Autre'],
  ...
  en: {
    ...
    platformOptions: ['OpenClaw', 'Hermes', 'ChatGPT Team', 'Claude', 'Gemini Spark', 'Microsoft Scout', 'Other'],
