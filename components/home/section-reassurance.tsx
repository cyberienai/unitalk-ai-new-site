const T = {
  fr: {
    items: [
      ...
      { label: 'Modèles IA', title: 'Le meilleur modèle adapté à chaque tâche', desc: 'Unitalk sélectionne le modèle autorisé le plus pertinent pour le travail à accomplir.' },
    ],
  },
  en: {
    items: [
      ...
      { label: 'AI models', title: 'The best model suited to each task', desc: 'Unitalk selects the most relevant authorized model for the work at hand.' },
    ],
  },
} as const
