...
const QUESTIONS = {
  fr: [
    ...
    ['À quoi sert le Workspace Unitalk ?', 'C’est l’espace de travail où humains et IA collaborent. Vous y suivez les missions, planifiez le travail, consultez les résultats et validez les actions sensibles.'],
  ...
  en: [
    ...
    ['What is Unitalk Workspace for?', 'It is the workspace where humans and AI collaborate. You can follow missions, schedule work, review outcomes and approve sensitive actions.'],
