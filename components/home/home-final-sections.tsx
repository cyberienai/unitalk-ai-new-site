...
const COPY = {
  fr: {
    ...
    evolutionTitle: <>Votre&nbsp;Collaborateur&nbsp;IA<br className="hidden lg:block" /> évolue avec vos besoins.</>,
    evolutionLead: 'Chaque mission validée enrichit ses compétences. Ajoutez des profils métier et des compétences de la Marketplace, ou créez les vôtres à partir de vos méthodes.',
    ...
    exampleBody: 'Il conserve le contexte utile et accède aux connaissances de l’entreprise selon ses droits.',
    governanceTitle: 'L’expérience reste gouvernée par votre entreprise.',
    governanceBody: 'Vos méthodes deviennent des compétences dont vous contrôlez l’accès.',
    marketplaceCta: 'Découvrir les Collaborateurs IA',
  ...
  en: {
    ...
    evolutionLead: 'Each approved mission enriches its skills. Add job profiles and skills from the Marketplace, or create your own from your methods.',
    ...
    marketplaceCta: 'Discover AI Collaborators',
