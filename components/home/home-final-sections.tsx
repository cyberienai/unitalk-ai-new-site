...
const COPY = {
  fr: {
    ...
    evolutionLead: 'Il démarre avec une première mission. Pour les suivantes, ajoutez des profils métier et des compétences testées par la communauté.',
  ...
  en: {
    ...
    evolutionLead: 'It starts with a first mission. For the next ones, add job profiles and skills tested by the community.',
