    ...
    plans: [
      {
        ...
        features: ['Profil Collaborateur IA pour Hermes', '5 millions de tokens inclus / mois', 'Onboarding standard', 'Support email'],
      },
      {
        price: '99€',
        period: '/ mois',
        ...
        features: ['Profil Collaborateur IA pour Hermes', '10 millions de tokens inclus / mois', 'Onboarding personnalisé', 'Support prioritaire'],
        featured: true,
      },
      {
        price: '149€',
        ...
        features: ['Profil Collaborateur IA pour Hermes', '20 millions de tokens inclus / mois', 'Onboarding sur-mesure', 'Supervision AgentOps (30m)'],
      },
    ],
    ...
    plans: [
      {
        ...
        features: ['AI Collaborator profile for Hermes', '5 million tokens included / mo', 'Standard onboarding', 'Email support'],
      },
      {
        price: '€99',
        period: '/ month',
        ...
        features: ['AI Collaborator profile for Hermes', '10 million tokens included / mo', 'Personalized onboarding', 'Priority support'],
        featured: true,
      },
      {
        price: '€149',
        ...
        features: ['AI Collaborator profile for Hermes', '20 million tokens included / mo', 'Bespoke onboarding', 'AgentOps supervision (30m)'],
      },
    ],
