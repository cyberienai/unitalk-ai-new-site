...
const COPY = {
  fr: {
    ...
    almaLead: 'Alma vous aide à choisir le bon profil.',
    ...
    capacityNote: 'Le niveau choisi détermine le volume de missions et d’actions pris en charge.',
    profiles: [
  ...
  en: {
    ...
    almaLead: 'Alma helps you choose the right profile.',
    ...
    capacityNote: 'The selected level determines the volume of missions and actions handled.',
    profiles: [
      ...
      <div className="editorial-shell">
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
          <div className="max-w-3xl text-center lg:text-left">
            ...
            <p className="mt-6 max-w-2xl text-[16px] leading-relaxed text-[#4E483F] md:text-[17px]">
              {t.lead} <AlmaInline />{' '}{t.almaLead}
            </p>
          </div>
