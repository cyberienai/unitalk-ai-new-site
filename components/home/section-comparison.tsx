...
const COPY = {
  fr: {
    ...
    lead: 'Un assistant comme ChatGPT ou Claude vous aide à produire. Votre Collaborateur IA prend en charge des missions, agit dans votre environnement de travail et progresse avec les méthodes que vous validez.',
    ...
    rows: [
      ...
      ['Reste dans son interface', 'Agit dans vos applications autorisées'],
      ['Suit vos instructions', 'Apprend vos méthodes validées'],
      ['Conserve le fil d’une conversation', 'Capitalise l’expérience mission après mission'],
      ['Un assistant pour tous vos sujets', 'Une identité durable, avec plusieurs profils métier'],
  ...
  en: {
    ...
    lead: 'An assistant such as ChatGPT or Claude helps you produce. Your AI Collaborator takes ownership of missions, acts in your work environment and improves through the methods you approve.',
    ...
    rows: [
      ...
      ['Stays within its interface', 'Acts in your authorized applications'],
      ['Follows your instructions', 'Learns your approved methods'],
      ['Keeps the thread of a conversation', 'Builds experience mission after mission'],
      ['One assistant for every topic', 'A durable identity with multiple job profiles'],
