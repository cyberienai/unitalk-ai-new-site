...
const COPY = {
  fr: {
    ...
    rows: [
      ['Un outil individuel et isolé', 'Une identité rattachée à une personne, une équipe ou l’organisation'],
      ['Répond dans son interface', 'Prend en charge des missions et communique par e-mail, téléphone et calendrier'],
      ['Conserve le fil d’une conversation', 'Partage avec l’entreprise une mémoire gouvernée selon les droits'],
      ['Suit vos instructions', 'Agit dans vos applications et soumet les actions sensibles'],
    ],
  },
  en: {
    ...
    rows: [
      ['An individual, isolated tool', 'An identity attached to a person, a team or the organization'],
      ['Answers inside its interface', 'Takes on missions and communicates by email, phone and calendar'],
      ['Keeps the thread of a conversation', 'Shares governed memory with the company according to permissions'],
      ['Follows your instructions', 'Acts in your applications and submits sensitive actions'],
    ],
  },
} as const
