    ...
    <section className="border-t border-[#E9E2D4] bg-[#FBF9F3] px-5 py-24 sm:px-8 sm:py-32">
      <div className="mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="max-w-xl">
          ...
          <p className="mt-5 text-pretty text-lg leading-relaxed text-[#5F594F]">{t.subtitle}</p>
        ...
        <div className="premium-shadow rounded-[1.75rem] border border-[#E4DCCF] bg-[#F3EFE6] p-6 sm:p-10">
          ...
          <ol className="relative mt-6 flex flex-col gap-6 pl-8">
            ...
            {t.steps.map((step, i) => (
              ...
              >
                <span
                  className="absolute -left-8 top-1 flex h-[19px] w-[19px] items-center justify-center rounded-full border-2 border-[#D10E63] bg-[#F3EFE6]"
                  aria-hidden="true"
                >
