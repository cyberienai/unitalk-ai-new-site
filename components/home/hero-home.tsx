...
const T = {
  fr: {
    ...
    srSentence: 'Un Collaborateur IA sait déjà répondre à vos appels, traiter vos emails, qualifier vos prospects, analyser vos données et bien plus.',
  ...
  en: {
    ...
    srSentence: 'An AI Collaborator already knows how to answer your calls, handle your emails, qualify your prospects, analyze your data and much more.',
