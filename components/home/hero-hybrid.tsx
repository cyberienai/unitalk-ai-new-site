...
const T = {
  fr: {
    ...
    subtitle: 'Décrivez le travail à accomplir. Alma personnalise votre Collaborateur IA selon vos besoins.',
  ...
  en: {
    ...
    subtitle: 'Describe the work to be done. Alma customizes your AI Collaborator to your needs.',
