...
const T = {
  fr: {
    ...
    subtitle: 'Décrivez le travail à accomplir. Alma personnalise votre Collaborateur IA pour votre entreprise.',
    ...
    voiceTitle: 'Quel travail voulez-vous lui confier ?',
    voiceBody: 'Décrivez simplement le résultat attendu.',
    ...
    examples: ['Répondre à mes clients', 'Préparer mes factures', 'Organiser mes rendez-vous'],
  ...
  en: {
    ...
    subtitle: 'Describe the work to be done. Alma customizes your AI Collaborator for your organization.',
    ...
    voiceBody: 'Simply describe the expected outcome.',
    ...
    examples: ['Reply to my customers', 'Prepare my invoices', 'Organize my meetings'],
