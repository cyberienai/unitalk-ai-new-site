...
const T = {
  fr: {
    ...
    voiceBody: 'Alma prépare le Collaborateur IA adapté.',
    ...
    examples: ['Répondre à mes appels', 'Qualifier mes prospects', 'Traiter mes e-mails entrants'],
  ...
  en: {
    ...
    proofs: ['First mission included', 'Mission scoped in minutes', 'No credit card'],
    cta: 'Describe my mission',
    voiceKicker: 'AI mission coordinator',
    voiceTitle: 'Describe your need.',
    voiceBody: 'Alma prepares the right AI Collaborator.',
    ...
    examples: ['Answer my calls', 'Qualify my prospects', 'Handle my incoming emails'],
