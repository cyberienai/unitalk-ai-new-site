...
const SOVEREIGNTY_PILLARS = [
  ...
  {
    icon: Cpu,
    title: 'Pas d\u2019entraînement des modèles d\u2019IA',
    description: 'Vos données ne servent pas à entraîner les modèles. Zéro rétention.',
    featured: false,
  },
  {
    icon: FileCheck,
...
const OFFERS = [
  {
    ...
    points: [
      ...
      'Sa propre identité : profil public, email, calendrier & téléphone',
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#1A1613] px-5 py-24 sm:px-6 sm:py-32 lg:px-8">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        >
          {"N'utilisez plus un simple agent. "}
          <span className="text-[#D10E63]">Créez un vrai collaborateur IA.</span>
        </motion.h2>
