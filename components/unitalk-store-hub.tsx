...
const COPY = {
  fr: {
    ...
    result: 'résultat', results: 'résultats', almaTitle: 'Vous avez une mission en tête ? Alma prépare le Collaborateur adapté.', almaBody: 'Décrivez le résultat attendu. Alma vous aide à choisir l’identité, les compétences, les sources autorisées et les validations humaines nécessaires.', almaAction: 'Décrire ma première mission', almaFinalAction: 'Préparer mon Collaborateur avec Alma',
  ...
  en: {
    ...
    result: 'result', results: 'results', almaTitle: 'Have a mission in mind? Alma prepares the right Collaborator.', almaBody: 'Describe the expected outcome. Alma helps you choose the identity, skills, authorized sources and required human approvals.', almaAction: 'Describe my first mission', almaFinalAction: 'Prepare my Collaborator with Alma',
