      ...
      <section className="relative border-b border-[#CFC5B5] px-5 pb-10 pt-28 sm:px-8 sm:pb-12 sm:pt-32">
        ...
        <div className="editorial-shell relative">
          <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-center lg:gap-16">
            ...
            <AlmaMissionComposer value={need} onChange={setNeed} onSubmit={handNeedToAlma} title={t.composerTitle} body={t.almaBody} role={t.almaRole} placeholder={t.placeholder} submitLabel={t.continue} starters={t.starters} listening={listening} onToggleListening={toggleListening} voiceStartLabel={t.talk} voiceStopLabel={t.stop} help={t.handoff} error={voiceError} status={t.ready} textareaRef={composerRef} />
          </div>
        </div>
      </section>
