...
const SERVER_HOSTS = [
  { key: 'ovhcloud', title: 'OVHcloud', logoPath: '/logos/ovhcloud.svg', meta: { fr: 'France · Cloud européen', en: 'France · European cloud' }, description: { fr: 'Régions françaises et européennes, avec des offres adaptées aux contraintes de souveraineté et de données sensibles.', en: 'French and European regions, with services suited to sovereignty and sensitive-data requirements.' }, fit: { fr: 'Souveraineté et implantation française', en: 'Sovereignty and French location' } },
  { key: 'scaleway', title: 'Scaleway', logoPath: '/logos/scaleway.svg', meta: { fr: 'France · Cloud CPU et GPU', en: 'France · CPU and GPU cloud' }, description: { fr: 'Infrastructure française avec ressources CPU et GPU disponibles dans plusieurs centres de données européens.', en: 'French infrastructure with CPU and GPU resources across several European data centers.' }, fit: { fr: 'IA, calcul et régions européennes', en: 'AI, compute and European regions' } },
  { key: 'outscale', title: 'OUTSCALE', meta: { fr: 'France · Cloud de confiance', en: 'France · Trusted cloud' }, description: { fr: 'Cloud de Dassault Systèmes destiné aux organisations soumises à des exigences élevées de sécurité et de conformité.', en: 'Dassault Systèmes cloud for organizations with demanding security and compliance requirements.' }, fit: { fr: 'Environnements sensibles et réglementés', en: 'Sensitive and regulated environments' } },
  { key: 'clever-cloud', title: 'Clever Cloud', logoPath: '/logos/clever-cloud.svg', meta: { fr: 'France · PaaS européen', en: 'France · European PaaS' }, description: { fr: 'Plateforme française automatisant le déploiement et l’exploitation d’applications sur une infrastructure européenne.', en: 'French platform automating application deployment and operations on European infrastructure.' }, fit: { fr: 'Déploiement applicatif managé', en: 'Managed application deployment' } },
  { key: 'ionos', title: 'IONOS', logoPath: '/logos/ionos.svg', meta: { fr: 'Allemagne · Cloud européen', en: 'Germany · European cloud' }, description: { fr: 'Cloud allemand avec centres de données européens et services d’infrastructure conçus pour les entreprises.', en: 'German cloud with European data centers and infrastructure services designed for organizations.' }, fit: { fr: 'Infrastructure d’entreprise en Europe', en: 'Enterprise infrastructure in Europe' } },
  { key: 'hetzner', title: 'Hetzner', logoPath: '/logos/hetzner.svg', meta: { fr: 'Allemagne · Finlande', en: 'Germany · Finland' }, description: { fr: 'Infrastructure européenne reconnue pour son rapport performance-prix, opérée en Allemagne et en Finlande.', en: 'European infrastructure known for price-performance, operated in Germany and Finland.' }, fit: { fr: 'Charges maîtrisées et coût optimisé', en: 'Controlled workloads and optimized cost' } },
  { key: 'open-telekom-cloud', title: 'Open Telekom Cloud', logoPath: '/logos/deutsche-telekom.svg', meta: { fr: 'Allemagne · Deutsche Telekom', en: 'Germany · Deutsche Telekom' }, description: { fr: 'Cloud exploité par Deutsche Telekom pour des environnements d’entreprise soumis au droit européen.', en: 'Deutsche Telekom-operated cloud for enterprise environments governed by European law.' }, fit: { fr: 'Entreprises et exigences européennes', en: 'Enterprise and European requirements' } },
  { key: 'infomaniak', title: 'Infomaniak', logoPath: '/logos/infomaniak.svg', meta: { fr: 'Suisse · Cloud indépendant', en: 'Switzerland · Independent cloud' }, description: { fr: 'Cloud suisse indépendant avec centres de données exploités en Suisse et politique environnementale documentée.', en: 'Independent Swiss cloud with Swiss-operated data centers and a documented environmental policy.' }, fit: { fr: 'Localisation suisse et indépendance', en: 'Swiss location and independence' } },
  { key: 'exoscale', title: 'Exoscale', logoPath: '/logos/exoscale.svg', meta: { fr: 'Suisse · Régions européennes', en: 'Switzerland · European regions' }, description: { fr: 'Cloud suisse présent dans plusieurs régions européennes, adapté aux déploiements distribués.', en: 'Swiss cloud available in several European regions, suited to distributed deployments.' }, fit: { fr: 'Déploiement multi-région européen', en: 'European multi-region deployment' } },
  { key: 'upcloud', title: 'UpCloud', logoPath: '/logos/upcloud.svg', meta: { fr: 'Finlande · Cloud européen', en: 'Finland · European cloud' }, description: { fr: 'Cloud finlandais haute performance avec plusieurs implantations européennes.', en: 'High-performance Finnish cloud with several European locations.' }, fit: { fr: 'Performance et flexibilité régionale', en: 'Performance and regional flexibility' } },
  { key: 'gcore', title: 'Gcore', logoPath: '/logos/gcore.svg', meta: { fr: 'Luxembourg · Cloud et edge', en: 'Luxembourg · Cloud and edge' }, description: { fr: 'Fournisseur européen de cloud et d’edge disposant d’un réseau international à faible latence.', en: 'European cloud and edge provider with a low-latency international network.' }, fit: { fr: 'Distribution internationale et faible latence', en: 'International delivery and low latency' } },
  { key: 'hostinger', title: 'Hostinger', logoPath: '/logos/hostinger.svg', meta: { fr: 'Lituanie · Hébergeur européen', en: 'Lithuania · European provider' }, description: { fr: 'Hébergeur basé en Lituanie proposant des infrastructures dans plusieurs centres de données européens.', en: 'Lithuanian hosting provider offering infrastructure across several European data centers.' }, fit: { fr: 'Déploiements européens accessibles', en: 'Accessible European deployments' } },
  { key: 'aws', title: 'Amazon Web Services', meta: { fr: 'Hyperscaler · Régions au choix', en: 'Hyperscaler · Selected regions' }, description: { fr: 'Déploiement dans les régions autorisées de votre environnement AWS, selon vos contrats et règles de gouvernance.', en: 'Deployment in approved regions of your AWS environment, according to your contracts and governance rules.' }, fit: { fr: 'Écosystèmes AWS existants', en: 'Existing AWS ecosystems' } },
  { key: 'azure', title: 'Microsoft Azure', meta: { fr: 'Hyperscaler · Écosystème Microsoft', en: 'Hyperscaler · Microsoft ecosystem' }, description: { fr: 'Déploiement intégré à votre environnement Microsoft, dans les régions et abonnements que votre entreprise autorise.', en: 'Deployment integrated with your Microsoft environment, in regions and subscriptions approved by your organization.' }, fit: { fr: 'Entreprises équipées Microsoft', en: 'Microsoft-based organizations' } },
  { key: 'google-cloud', title: 'Google Cloud', meta: { fr: 'Hyperscaler · Régions au choix', en: 'Hyperscaler · Selected regions' }, description: { fr: 'Déploiement dans votre environnement Google Cloud selon les régions, contrats et exigences techniques autorisés.', en: 'Deployment in your Google Cloud environment according to approved regions, contracts and technical requirements.' }, fit: { fr: 'Données, IA et écosystème Google', en: 'Data, AI and Google ecosystem' } },
  { key: 'oracle-cloud', title: 'Oracle Cloud', meta: { fr: 'Hyperscaler · Charges Oracle', en: 'Hyperscaler · Oracle workloads' }, description: { fr: 'Déploiement sur Oracle Cloud selon vos contrats, vos charges de travail et les régions approuvées.', en: 'Deployment on Oracle Cloud according to your contracts, workloads and approved regions.' }, fit: { fr: 'Systèmes et charges Oracle', en: 'Oracle systems and workloads' } },
] as const
...
function itemsForCategory(categoryId: string, lang: Lang): MarketplaceItem[] {
  ...
  if (categoryId === 'serveurs-ia') {
    ...
    const hostItems: MarketplaceItem[] = SERVER_HOSTS.map((host) => ({
      ...
      href: `/decouvrir?source=marketplace-servers&intention=hebergeur&q=${encodeURIComponent(host.title)}`, meta: host.meta[lang], origin: lang === 'fr' ? 'Hébergeurs' : 'Hosting providers', logoPath: 'logoPath' in host ? host.logoPath : undefined,
...
function MarketplaceFaq({ categoryId, lang }: { categoryId: string; lang: Lang }) {
  ...
  const collaborators = categoryId === 'collaborateurs-ia'
  const collaboratorQuestions: Array<[string, string]> = lang === 'fr' ? [
    ['Les Collaborateurs IA sont-ils disponibles ?', 'Oui. Les Collaborateurs IA présentés peuvent être choisis dès maintenant. Alma adapte ensuite leur première mission, leurs outils et leurs accès à votre entreprise.'],
    ['Qu’est-ce qui est inclus ?', 'Chaque Collaborateur IA comprend une identité professionnelle, une mémoire et un agent Hermes dédié. Ses profils métier et compétences sont illimités. Il dispose aussi de 5 millions de tokens par mois et de ses outils de communication : email, calendrier, téléphone et messageries compatibles.'],
    ['Quel est le prix ?', 'Un Collaborateur IA coûte 49 € HT/mois avec 5 millions de tokens inclus par mois. La licence Workspace couvre les Collaborateurs humains selon le palier choisi, sans facturation individuelle dans cette limite.'],
    ['De quoi ai-je besoin pour commencer ?', 'Décrivez la mission à accomplir. Alma identifie le Collaborateur IA, les profils, les compétences, les applications et les accès nécessaires, puis prépare la configuration avec vous.'],
    ['Puis-je essayer gratuitement ?', 'Oui. Votre première mission est offerte, sans carte bancaire. Elle prend fin lorsqu’elle est terminée, après 7 jours ou après 1 million de tokens, selon la première limite atteinte.'],
    ['Comment mon Collaborateur IA évolue-t-il ?', 'Vous pouvez lui ajouter de nouveaux profils métier, compétences et outils sans perdre son identité, sa mémoire ni l’historique de ses missions. Unitalk met à jour les éléments qu’il publie. Pour les éléments créés par la communauté, la fiche indique qui les maintient.'],
  ] : [
    ['Are AI Collaborators available?', 'Yes. The listed AI Collaborators can be selected now. Alma then adapts their first mission, tools and access to your organization.'],
    ['What is included?', 'Each AI Collaborator includes a professional identity, memory and a dedicated Hermes agent. Job profiles and skills are unlimited. It also includes 5 million tokens per month and communication tools: email, calendar, phone and compatible messaging platforms.'],
    ['What does it cost?', 'An AI Collaborator costs €49 per month excluding tax with 5 million tokens included per month. The Workspace license covers human Collaborators up to the selected tier, with no individual charge within that limit.'],
    ['What do I need to get started?', 'Describe the mission. Alma identifies the AI Collaborator, profiles, skills, applications and required access, then prepares the configuration with you.'],
    ['Can I try it for free?', 'Yes. Your first mission is included with no credit card. It ends when complete, after 7 days or after 1 million tokens, whichever comes first.'],
    ['How does my AI Collaborator evolve?', 'You can add new job profiles, skills and tools without losing its identity, memory or mission history. Unitalk updates the items it publishes. Community-created items identify who maintains them.'],
  ]
  const questions: Array<[string, string]> = collaborators ? collaboratorQuestions : lang === 'fr' ? [
    ['Est-ce disponible ?', applications ? 'Chaque fiche indique son statut. « Bientôt disponible » signifie que vous pouvez demander l’intégration, pas la connecter immédiatement.' : servers ? 'Les offres Unitalk AI Cloud affichées sont disponibles. Le fournisseur, la région et la capacité sont confirmés avant activation.' : categoryId === 'profils-metier' ? 'Les profils métier publiés sont disponibles immédiatement. Si la responsabilité nécessaire n’existe pas encore, Alma construit le nouveau profil avec vous et peut solliciter un ingénieur IA. Vous en devenez co-créateur, sans coût supplémentaire.' : categoryId === 'competences' ? 'Les compétences publiées sont disponibles immédiatement. Si le savoir-faire nécessaire à votre mission n’existe pas encore, Alma crée la nouvelle compétence avec vous et peut solliciter un ingénieur IA. Vous en devenez co-créateur, sans coût supplémentaire.' : 'Oui, lorsque la fiche est publiée comme disponible. Alma vérifie avec vous la compatibilité et les accès nécessaires avant l’activation.'],
    ['Qu’est-ce qui est inclus ?', servers ? 'La capacité affichée et la configuration gérée par Unitalk sont décrites sur chaque fiche. Le périmètre d’exploitation dépend de l’offre retenue.' : 'La fiche précise ce que l’élément apporte et les usages qu’il permet. Les éventuelles conditions d’accès ou de configuration sont confirmées avant son activation.'],
    ['Quel est le prix ?', categoryId === 'competences' ? 'Les compétences sont incluses sans coût unitaire avec une offre Unitalk compatible.' : applications ? 'Unitalk ne facture pas chaque connexion séparément. L’abonnement Unitalk et les éventuels frais facturés par l’éditeur de l’application restent distincts.' : servers ? 'Le prix dépend de la capacité, de la région, de l’hébergeur et du niveau d’exploitation choisi. Un montant est confirmé avant le déploiement.' : 'La fiche indique ce qui est inclus. Lorsqu’un coût supplémentaire s’applique, il est présenté avant l’activation.'],
    ['De quoi ai-je besoin pour commencer ?', applications ? 'Vous devez disposer d’un compte auprès du fournisseur et autoriser uniquement les accès utiles. Alma vérifie ces éléments avec vous avant la connexion.' : servers ? 'Vous précisez les applications à exécuter, la région souhaitée et vos exigences de sécurité. Unitalk confirme ensuite la configuration adaptée.' : 'Décrivez d’abord la mission à accomplir. Alma identifie les profils, compétences et accès nécessaires avant toute activation.'],
    ...
    ['How does this item evolve?', servers ? 'Unitalk maintains Unitalk AI Cloud offer configuration. With another host, the responsibilities of Unitalk, the provider and your organization are defined before deployment.' : applications ? 'The publisher maintains its application. Unitalk maintains the integration when supplied by Unitalk; responsibilities are defined before connection.' : 'Unitalk maintains items published by Unitalk. Community items identify their author and maintenance terms.'],
  ]
  return <section id="marketplace-faq" aria-labelledby="marketplace-faq-title" className="mt-16 border-t border-[#D8D0C2] pt-12"><div className="grid gap-9 lg:grid-cols-[.72fr_1.28fr] lg:gap-16"><div><Kicker>{lang === 'fr' ? 'Questions pratiques' : 'Practical questions'}</Kicker><h2 id="marketplace-faq-title" className="mt-5 max-w-lg text-balance text-[clamp(2.35rem,4.5vw,4.25rem)] font-semibold leading-[.95] tracking-[-.06em]">{lang === 'fr' ? <>Avant de choisir<span className="block text-[#D10E63]">votre Collaborateur IA.</span></> : <>Before choosing<span className="block text-[#D10E63]">your AI Collaborator.</span></>}</h2></div><div className="border-t border-[#CFC5B5]">{questions.map(([question, answer]) => <details key={question} className="group border-b border-[#CFC5B5]"><summary className="flex min-h-16 cursor-pointer list-none items-center justify-between gap-5 py-4 text-left text-[15px] font-bold marker:content-none"><span>{question}</span><span aria-hidden className="flex size-8 shrink-0 items-center justify-center text-xl font-normal text-[#D10E63] transition-transform group-open:rotate-45">+</span></summary><p className="max-w-2xl pb-6 pr-10 text-sm leading-7 text-[#625B50]">{answer}</p></details>)}</div></div></section>
}
...
function CatalogItemCard({ item, lang, category, labels }: { item: MarketplaceItem; lang: Lang; category: Category; labels: { details: string; add: string } }) {
  ...
  if (category.id === 'serveurs-ia') {
    ...
    const content = <>
      <div aria-hidden className="absolute inset-x-0 top-0 h-[3px] origin-left scale-x-0 bg-[#C80B5B] transition-transform duration-300 group-hover:scale-x-100 group-focus-visible:scale-x-100" />
      <div className="flex items-center gap-3.5">{isOpenSourceApp && item.iconSlug ? <span className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FAF8F3] ring-1 ring-[#D8D0C2]"><OpenSourceAppLogo slug={item.iconSlug} /></span> : item.facetKey === 'hebergeurs' ? <HostLogo item={item}/> : null}<div className="min-w-0"><p className="font-mono text-[9px] font-black uppercase tracking-[.13em] text-[#B00C54]">{item.meta}</p><h3 className="mt-2 line-clamp-2 text-[22px] font-semibold leading-none tracking-[-.04em] text-[#1C1A17]">{item.title}</h3></div></div>
      <p className="mt-4 line-clamp-3 text-[13px] font-medium leading-[1.35rem] text-[#3F3A33] sm:text-[14px] sm:leading-6 sm:text-[#4E483F]">{item.description}</p>
...
function HostLogo({ item }: { item: MarketplaceItem }) {
  return <span className="flex h-12 w-20 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-white px-2 ring-1 ring-[#D8D0C2]">{item.logoPath ? <Image src={item.logoPath} alt={`Logo ${item.title}`} width={64} height={32} className="max-h-8 w-auto max-w-full object-contain" /> : <span className="text-center text-[10px] font-black leading-3 tracking-[-.03em] text-[#1C1A17]">{item.title}</span>}</span>
}
