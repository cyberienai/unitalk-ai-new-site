...
const COPY = {
  fr: {
    ...
    benefits: ['44 profils prêts à adapter', 'Profils métier illimités', 'Méthodes et droits personnalisables', 'Validation humaine configurable'],
    ...
    catalogLead: 'Choisissez un profil existant. Alma l’adapte ensuite aux méthodes, applications, droits et validations de votre Entreprise.',
