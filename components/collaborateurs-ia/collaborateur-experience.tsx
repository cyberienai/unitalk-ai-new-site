...
const COPY = {
  fr: {
    eyebrow: 'L’IA rejoint votre organisation', heroTitle: 'Ajoutez un Collaborateur IA à votre équipe.', heroAccent: 'Confiez-lui une première mission.', heroLead: 'Une identité, une mémoire et un rôle sous votre contrôle. Il travaille avec vos équipes, dans vos outils, et s’améliore mission après mission.',
    heroGroups: [{ label: 'Dans l’entreprise', value: 'Un rôle clair · Une mémoire sous votre contrôle' }, { label: 'Pour travailler', value: 'Profils métier · Compétences\nConnexion à plus de 3 000 apps' }, { label: 'Pour durer', value: 'Meilleurs modèles d’IA · Un serveur privé dédié' }], heroCardKicker: 'Votre entreprise', heroCardTitle: 'Humains et IA, dans la même équipe', heroCardTeam: 'Vos Collaborateurs IA', heroCardTeamBody: 'Une identité et des responsabilités pour chacun', heroCardRule: 'Vous décidez de leurs accès et des actions qui restent humaines.', start: 'Confier une première mission', understand: 'Comprendre le Collaborateur IA', reassurance: ['Première mission gratuite', 'Sans carte bancaire'], almaGuidance: 'Personnalisation guidée par Alma',
  ...
  en: {
    eyebrow: 'AI joins your organization', heroTitle: 'Add an AI Collaborator to your team.', heroAccent: 'Give it a first mission.', heroLead: 'An identity, memory and role under your control. It works with your teams, in your tools, and improves with every mission.',
    heroGroups: [{ label: 'In the organization', value: 'A clear role · Memory under your control' }, { label: 'To get work done', value: 'Job profiles · Skills\nConnects to 3,000+ apps' }, { label: 'Built to last', value: 'Leading AI models · A dedicated private server' }], heroCardKicker: 'Your organization', heroCardTitle: 'People and AI, on the same team', heroCardTeam: 'Your AI Collaborators', heroCardTeamBody: 'An identity and responsibilities for each', heroCardRule: 'You decide their access and which actions remain human.', start: 'Entrust a first mission', understand: 'Understand the AI Collaborator', reassurance: ['First mission free', 'No card'], almaGuidance: 'Personalized with Alma',
