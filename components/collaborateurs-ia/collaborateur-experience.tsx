        ...
        <div className="editorial-shell relative grid items-center gap-9 sm:gap-12 lg:grid-cols-[1.02fr_.98fr] lg:gap-16 [@media(min-width:1024px)_and_(max-height:850px)]:gap-10">
            <div className="max-w-[640px] lg:pr-4">
              ...
              <div className="mt-7 flex flex-col items-stretch gap-3 sm:flex-row sm:items-start [@media(min-width:1024px)_and_(max-height:850px)]:mt-6">
                ...
                <Link href="/marketplace/collaborateurs-ia" className="inline-flex min-h-13 items-center justify-center gap-2 rounded-full border border-[#BFB4A4] bg-[#FAF8F3]/75 px-7 text-center text-sm font-bold outline-none transition hover:border-[#191715] hover:bg-[#191715] hover:text-white focus-visible:ring-2 focus-visible:ring-[#D10E63]">{t.explore}<ArrowRight className="size-4 shrink-0" /></Link>
              </div>
...
const COPY = {
  fr: {
    eyebrow: 'Une nouvelle capacité pour votre équipe', heroTitle: 'Un Collaborateur IA rejoint votre entreprise.', heroAccent: 'Il progresse à chaque mission.', heroLead: 'Une identité, une mémoire et des responsabilités sous votre contrôle. Il travaille avec vos équipes, dans vos outils.',
    heroGroups: [{ label: 'Dans votre organisation', value: 'Identité définie · Mémoire sous votre contrôle' }, { label: 'Équipé pour travailler', value: 'Profils · Compétences\nPlus de 3 000 apps' }, { label: 'Infrastructure dédiée', value: 'Meilleurs modèles d’IA · Serveur privé' }], heroCardKicker: 'Votre entreprise', heroCardTitle: 'Humains et IA, dans la même équipe', heroCardRule: 'Vous contrôlez ses accès et les décisions qui restent humaines.', start: 'Confier une première mission', explore: 'Voir les Collaborateurs IA', reassurance: ['Première mission gratuite', 'Sans carte bancaire'], almaGuidance: 'Personnalisation guidée par Alma',
  ...
  en: {
    eyebrow: 'A new capability for your team', heroTitle: 'An AI Collaborator joins your organization.', heroAccent: 'It improves with every mission.', heroLead: 'An identity, memory and responsibilities under your control. It works with your teams, in your tools.',
    heroGroups: [{ label: 'In your organization', value: 'Defined identity · Memory under your control' }, { label: 'Equipped to work', value: 'Profiles · Skills\n3,000+ apps' }, { label: 'Dedicated infrastructure', value: 'Leading AI models · Private server' }], heroCardKicker: 'Your organization', heroCardTitle: 'People and AI, on the same team', heroCardRule: 'You control its access and the decisions that remain human.', start: 'Entrust a first mission', explore: 'View AI Collaborators', reassurance: ['First mission free', 'No card'], almaGuidance: 'Personalized with Alma',
