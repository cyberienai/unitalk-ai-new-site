...
export function CollaborateurExperience() {
  ...
  return (
    <main className="overflow-hidden bg-[#F3EFE6] font-sf text-[#191715]">
      <section aria-labelledby="collaborateurs-ia-title" className="relative overflow-hidden border-b border-[#D8CEBE] bg-[#EAE3D4] pb-14 pt-28 sm:pb-20 sm:pt-36 [@media(min-width:1024px)_and_(max-height:850px)]:pb-12 [@media(min-width:1024px)_and_(max-height:850px)]:pt-28">
