...
const T = {
  fr: {
    ...
    msg2: 'Je crée un collaborateur IA sur mesure pour votre entreprise.',
    ...
    msg5: 'Je reste ensuite à vos côtés pour créer de nouveaux agents et les faire progresser.',
