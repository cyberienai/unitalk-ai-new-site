...
const T = {
  fr: {
    ...
    almaSteps: [
      ...
      { n: '04', label: 'Configuration & intégrations', desc: 'Crée l\'agent Hermès, connecte vos apps (Slack, HubSpot, Gmail, etc.)' },
      { n: '05', label: 'Planifie une tâche', desc: 'Lance sa première mission en production' },
      { n: '06', label: 'Suivi & amélioration', desc: 'Évalue satisfaction hebdomadaire, optimise' },
    ],
  ...
  en: {
    ...
    almaSteps: [
      ...
      { n: '04', label: 'Config. & integrations', desc: 'Creates Hermès agent, connects your apps (Slack, HubSpot, Gmail, etc.)' },
      { n: '05', label: 'Schedule a task', desc: 'Launches its first mission to production' },
      { n: '06', label: 'Follow-up & improvement', desc: 'Evaluates satisfaction weekly, optimizes' },
    ],
