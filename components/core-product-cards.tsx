...
const T = {
  fr: {
    ...
    cards: [
      ...
      { icon: Zap, title: 'Des compétences', description: 'Compétences adaptées à chaque profil et chaque mission. Sait quoi faire et comment le faire.' },
  ...
  en: {
    ...
    cards: [
      ...
      { icon: Zap, title: 'Skills', description: 'Skills tailored to each profile and mission. Knows what to do and how to do it.' },
