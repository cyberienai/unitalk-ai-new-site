...
const T = {
  fr: {
    ...
    cards: [
      ...
      { icon: Cpu, title: 'Des ressources', description: 'CPU, RAM et stockage sécurisé dédiés. Ses tâches tournent 24/7, en toute autonomie.' },
  ...
  en: {
    ...
    cards: [
      ...
      { icon: Wrench, title: 'Tools', description: 'Email, calendar, CRM, files. Runs code and browses the web through 3,000+ integrations.' },
      { icon: Cpu, title: 'Resources', description: 'Dedicated CPU, RAM and secure storage. Its tasks run 24/7, fully autonomously.' },
