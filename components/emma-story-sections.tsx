  ...
  fr: {
    ...
    team: {
      ...
      members: [
        ...
        { id: 'sophia', name: 'Sophia', role: 'Support' },
        { id: 'lucas', name: 'Lucas', role: 'Commercial' },
        { id: 'noah', name: 'Noah', role: 'Marketing' },
        { id: 'sarah', name: 'Sarah', role: 'Finance' },
      ],
    },
    ...
    directory: {
      ...
      people: [
        ...
        { name: 'Lucas', role: 'Commercial', human: false },
        { name: 'Sophia', role: 'Support', human: false },
        { name: 'Sarah', role: 'Finance', human: false },
        { name: 'Noah', role: 'Marketing', human: false },
      ],
    },
  },
  en: {
    ...
    team: {
      ...
      members: [
        { id: 'emma', name: 'Emma', role: 'Executive Assistant' },
        { id: 'sophia', name: 'Sophia', role: 'Support' },
        { id: 'lucas', name: 'Lucas', role: 'Sales' },
        { id: 'noah', name: 'Noah', role: 'Marketing' },
        { id: 'sarah', name: 'Sarah', role: 'Finance' },
      ],
    },
    directory: {
      ...
      people: [
        { name: 'Patrick', role: 'CEO', human: true },
        { name: 'Emma', role: 'Executive Assistant', human: false },
        { name: 'Lucas', role: 'Sales', human: false },
        { name: 'Sophia', role: 'Support', human: false },
        { name: 'Sarah', role: 'Finance', human: false },
        { name: 'Noah', role: 'Marketing', human: false },
      ],
