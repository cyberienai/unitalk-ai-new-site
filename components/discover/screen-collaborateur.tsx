...
export function ScreenCollaborateur({
  ...
  const companyDomain = company.find((fact) => fact.key === 'domain')?.value || companyName
  ...
  return (
    <div className="grid overflow-hidden rounded-[2rem] border border-[#DED5C5] bg-[#FBF9F3] shadow-[0_30px_80px_-42px_rgba(28,26,23,0.5)] lg:min-h-[31rem] lg:grid-cols-[minmax(16rem,1fr)_minmax(0,2fr)]">
      ...
      <section className="grid min-w-0 lg:grid-rows-[auto_1fr]">
        <div className="border-b border-[#EAE3D5] bg-white px-6 py-5 sm:px-9 lg:px-10">
        ...
        <div className="grid px-6 py-5 sm:grid-cols-2 sm:px-9 lg:px-10">
          <div className="sm:col-start-2">
            <div className="flex justify-end">
              <span
                aria-hidden="true"
                className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-[#D10E63]/45 bg-white font-sf text-2xl font-bold text-[#D10E63] transition-colors"
              >
                {initial}
              </span>
            </div>
