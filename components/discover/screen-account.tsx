...
const COPY = {
  fr: {
    ...
    missionAlmaBody: 'Après votre connexion, je vous aide à adapter cette mission à votre entreprise, puis à préparer le Collaborateur IA qui l\'accomplira.',
  ...
  en: {
    ...
    missionAlmaBody: 'After you sign in, I help adapt this mission to your company, then prepare the AI Collaborator that will accomplish it.',
