...
const COPY = {
  fr: {
    alma: 'Personnalisons cette mission pour votre entreprise.', almaRole: 'Conseillère IA · Unitalk', selectedMission: 'Mission sélectionnée', companyDone: 'Entreprise confirmée', companyFallback: 'Votre entreprise', title: 'Précisons votre mission.', intro: 'Définissez le cadre qu’Alma et votre Collaborateur IA devront respecter.', required: 'Ce champ est requis.', continue: 'Valider la mission', fields: { title: 'Mission', target: 'Cible', criteria: 'Critères', sources: 'Sources autorisées', exclusions: 'Exclusions', result: 'Résultat attendu', validation: 'Validations humaines', rule: 'Règle' }, placeholders: { title: '', target: 'Ex. PME françaises dans le logiciel B2B', criteria: 'Ex. taille, secteur, zone géographique', sources: 'Ex. sites publics, CRM autorisé', exclusions: 'Ex. clients existants, concurrents', result: 'Décrivez le résultat utile attendu', validation: 'Ex. validation obligatoire avant toute prise de contact', rule: '' },
  },
  en: {
    alma: 'Let’s personalize this mission for your company.', almaRole: 'AI Advisor · Unitalk', selectedMission: 'Selected mission', companyDone: 'Company confirmed', companyFallback: 'Your company', title: 'Let’s refine your mission.', intro: 'Define the framework Alma and your AI Collaborator must follow.', required: 'This field is required.', continue: 'Confirm mission', fields: { title: 'Mission', target: 'Target', criteria: 'Criteria', sources: 'Authorized sources', exclusions: 'Exclusions', result: 'Expected result', validation: 'Human approvals', rule: 'Rule' }, placeholders: { title: '', target: 'e.g. French B2B software SMEs', criteria: 'e.g. size, industry, geography', sources: 'e.g. public websites, authorized CRM', exclusions: 'e.g. existing customers, competitors', result: 'Describe the useful expected result', validation: 'e.g. approval required before any outreach', rule: '' },
  },
} as const
