    ...
    plans: [
      {
        ...
        cta: 'Créer mon agent', href: '/creer',
      ...
      },
      {
        ...
        cta: 'Équiper mon équipe', href: '/creer', highlight: true,
      ...
      },
      {
        ...
        cta: 'Parler à un expert', href: '/creer',
    ...
    plans: [
      {
        ...
        cta: 'Create my agent', href: '/creer',
      ...
      },
      {
        ...
        cta: 'Equip my team', href: '/creer', highlight: true,
      ...
      },
      {
        ...
        cta: 'Talk to an expert', href: '/creer',
