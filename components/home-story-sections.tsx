...
const content = {
  fr: {
    ...
    infra: ['Serveur IA privé', 'Infrastructure managée', 'Mises à jour continues', 'Sauvegardes automatiques', 'Sécurité', 'Contrôle et réversibilité'],
  ...
  en: {
    ...
    infra: ['Private AI server', 'Managed infrastructure', 'Continuous updates', 'Automatic backups', 'Security', 'Control and reversibility'],
...
function Heading({ title, body, center = false }: { title: string; body?: string; center?: boolean }) {
  return (
    <div className={center ? 'mx-auto max-w-3xl text-center' : 'max-w-3xl'}>
      <h2 className="text-balance font-serif text-4xl font-semibold tracking-tight text-[#1C1A17] md:text-6xl">{title}</h2>
    ...
    <>
      <section className="overflow-hidden bg-[#1C1A17] px-5 py-24 text-[#FBF9F3] md:py-36">
        <Reveal className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-5xl text-center">
            <h2 className="text-balance font-serif text-4xl font-semibold tracking-tight md:text-7xl">{t.breakTitle}</h2>
            <p className="mt-5 text-balance font-serif text-4xl font-semibold tracking-tight text-[#E0186A] md:text-7xl">{t.breakAccent}</p>
      ...
      <section className="bg-[#F3EFE6] px-5 py-24 md:py-32">
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <Reveal>
            <p className="mb-5 text-xs font-bold tracking-[0.22em] text-[#D10E63]">{t.moreEyebrow}</p>
      ...
      <section className="bg-[#FBF9F3] px-5 py-24 md:py-32">
        <Reveal className="mx-auto max-w-6xl"><Heading title={t.teamTitle} body={t.teamBody} center />
      ...
      <section className="bg-[#F3EFE6] px-5 py-24 md:py-32">
        <Reveal className="mx-auto max-w-6xl"><Heading title={t.connectedTitle} body={t.connectedBody} center />
      ...
      <section className="bg-[#FBF9F3] px-5 py-24 md:py-32"><Reveal className="mx-auto max-w-6xl"><Heading title={t.memoryTitle} body={t.memoryBody} center />
      ...
      <section className="bg-[#1C1A17] px-5 py-24 text-[#FBF9F3] md:py-32"><Reveal className="mx-auto max-w-6xl"><div className="mx-auto max-w-3xl text-center"><h2 className="text-balance font-serif text-4xl font-semibold md:text-6xl">{t.infraTitle}</h2><p className="mt-5 text-pretty text-[#BDB5A9] md:text-lg">{t.infraBody}</p></div><div className="mt-14 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">{t.infra.map((item, index) => { const Icon = infraIcons[index]; return <div key={item} className="flex items-center gap-4 rounded-2xl border border-[#FBF9F3]/15 bg-[#FBF9F3]/5 p-5"><span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#E0186A]"><Icon className="h-5 w-5" /></span><p className="font-semibold">{item}</p><Check className="ml-auto h-4 w-4 text-[#E0186A]" /></div> })}</div></Reveal></section>
