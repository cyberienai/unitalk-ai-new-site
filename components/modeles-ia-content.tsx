...
const T = {
  fr: {
    eyebrow: 'Modèles IA / Accès', heroA: 'Les modèles IA auxquels', heroB: 'vos Collaborateurs', heroC: 'ont accès.',
    lead: 'Unitalk sélectionne automatiquement le modèle le plus pertinent pour chaque mission. Vous voyez et contrôlez les modèles disponibles pour votre entreprise.',
    ...
    catalogKicker: 'Accès transparent', catalogTitle: 'Une équipe d’intelligences derrière chaque Collaborateur IA.', catalogBody: 'Vous n’avez pas à choisir le modèle. Votre Collaborateur utilise automatiquement l’intelligence la plus adaptée à la tâche, parmi les modèles autorisés. Les versions et disponibilités évoluent.',
  ...
  en: {
    eyebrow: 'AI models / Access', heroA: 'The AI models', heroB: 'your Collaborators', heroC: 'can access.', lead: 'Unitalk automatically selects the most relevant model for each mission. You can see and control the models available to your company.', primary: 'Choose capacity', secondary: 'Understand AI Gateway', ribbon: ['Multiple providers', 'One shared policy', 'Attributed costs', 'No imposed model'],
    catalogKicker: 'Transparent access', catalogTitle: 'A team of intelligences behind every AI Collaborator.', catalogBody: 'You do not have to choose the model. Your Collaborator automatically uses the intelligence best suited to the task, among authorized models. Versions and availability evolve.', formats: [['Reason', Sparkles], ['See', Eye], ['Create images', ImageIcon], ['Listen and speak', Mic2], ['Code', Code2]] as const, gatewayLink: 'View routing and governance',
