...
const T = {
  fr: {
    ...
    subtitle: 'La catégorie « assistant IA » est saturée d’outils qui se ressemblent. Un Collaborateur IA, lui, n’en est pas un de plus.',
    ...
    rows: [
      ...
      { old: 'Reste bloqué sur une seule fonction', neo: 'Cumule profils métier et compétences, sans limite' },
      ...
      { old: 'Un outil de plus à piloter', neo: 'Prend en charge des missions entières' },
    ],
  },
  en: {
    eyebrow: 'The difference',
    title: 'Everyone rents software. You own your AI Collaborators.',
    subtitle: 'The “AI assistant” category is crowded with tools that all look alike. An AI Collaborator isn’t just one more of them.',
    ...
    rows: [
      ...
      { old: 'Stuck on a single function', neo: 'Stacks business profiles and skills, without limit' },
      ...
      { old: 'One more tool to operate', neo: 'Takes on entire missions' },
    ],
  },
} as const
