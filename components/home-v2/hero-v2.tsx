...
const T = {
  fr: {
    ...
    line2: 'Prenez un collègue.',
    lead: 'Unitalk ne vous vend pas un outil de plus. Vous accueillez un Collaborateur IA : un collègue qui appartient à votre organisation, garde une identité, une mémoire, et apprend votre métier.',
    domainLabel: 'Connectez votre site web',
    domainHelp: 'Alma en fait un collègue prêt à travailler, façonné pour votre activité.',
  ...
  en: {
    ...
    line2: 'Hire a colleague.',
    lead: 'Unitalk doesn’t sell you another tool. You welcome an AI Collaborator: a colleague who belongs to your organization, keeps an identity, a memory, and learns your business.',
    domainLabel: 'Connect your website',
    domainHelp: 'Alma turns it into a colleague ready to work, shaped for your business.',
