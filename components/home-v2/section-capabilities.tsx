...
const T = {
  fr: {
    ...
    groups: [
      ...
      { icon: Briefcase, title: 'Vente', items: ['Prospection', 'Devis', 'CRM'] },
      { icon: Megaphone, title: 'Marketing', items: ['Contenus', 'Réseaux sociaux', 'Newsletters'] },
      { icon: FileText, title: 'Documents', items: ['Analyse', 'Résumés', 'Rapports'] },
      { icon: Settings2, title: 'Opérations', items: ['Automatisation', 'Workflows', 'Connecteurs'] },
      { icon: BrainCircuit, title: 'Intelligence', items: ['Mémoire d’entreprise', 'Tous les modèles IA', 'Recherche'] },
      { icon: Plug, title: 'Applications', items: ['3 000+ intégrations', 'Vos outils', 'API ouvertes'] },
  ...
  en: {
    ...
    groups: [
      ...
      { icon: Briefcase, title: 'Sales', items: ['Prospecting', 'Quotes', 'CRM'] },
      { icon: Megaphone, title: 'Marketing', items: ['Content', 'Social media', 'Newsletters'] },
      { icon: FileText, title: 'Documents', items: ['Analysis', 'Summaries', 'Reports'] },
      { icon: Settings2, title: 'Operations', items: ['Automation', 'Workflows', 'Connectors'] },
      { icon: BrainCircuit, title: 'Intelligence', items: ['Company memory', 'Every AI model', 'Research'] },
      { icon: Plug, title: 'Applications', items: ['3,000+ integrations', 'Your tools', 'Open APIs'] },
