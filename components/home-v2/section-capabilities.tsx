...
const T = {
  fr: {
    ...
    groups: [
      ...
      { icon: BrainCircuit, title: 'Intelligence', items: ['Contexte d’entreprise', 'Tous les modèles IA', 'Recherche & Veille'] },
  ...
  en: {
    ...
    groups: [
      ...
      { icon: BrainCircuit, title: 'Intelligence', items: ['Company context', 'Every AI model', 'Research & monitoring'] },
