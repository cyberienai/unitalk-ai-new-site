  ...
  fr: {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          'Sa propre identité : email, téléphone et calendrier',
          'Une mémoire métier durable',
          'Expertises, compétences et missions illimitées',
        ],
        highlight: true,
      },
    ],
  ...
  en: {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          'Its own identity: email, phone and calendar',
          'A lasting business memory',
          'Unlimited expertise, skills and missions',
        ],
        highlight: true,
      },
    ],
