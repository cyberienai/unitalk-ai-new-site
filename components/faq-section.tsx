...
const T = {
  fr: {
    ...
    faqs: [
      ...
      { q: "Comment fonctionne la tarification ?", a: "Solo : 30€/mois pour 1 Collaborateur IA personnalisé, avec 7 jours d'essai gratuit. Teams : 25€/mois par Collaborateur IA pour un workspace d'équipe partagé. Business : 299€/mois pour un serveur privé dédié avec des Collaborateurs IA illimités. Tous les plans évoluent et sont résiliables à tout moment." },
      { q: "Où sont hébergées mes données ?", a: "Les serveurs Unitalk sont hébergés en France pour la souveraineté des données. Toutes les données sont chiffrées et isolées. Avec le plan Business, vous pouvez déployer sur votre propre infrastructure pour un contrôle total." },
  ...
  en: {
    ...
    faqs: [
      ...
      { q: 'How does pricing work?', a: 'Solo: €30/month for 1 custom AI Collaborator, with a 7-day free trial. Teams: €25/month per AI Collaborator for a shared team workspace. Business: €299/month for a dedicated private server with unlimited AI Collaborators. All plans scale and are cancellable anytime.' },
      { q: 'Where is my data hosted?', a: 'Unitalk servers are hosted in France for data sovereignty. All data is encrypted and isolated. With the Business plan, you can deploy on your own infrastructure for complete control.' },
