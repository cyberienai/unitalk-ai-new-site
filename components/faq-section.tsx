...
const T = {
  fr: {
    ...
    faqs: [
      ...
      { q: 'Comment fonctionne la tarification ?', a: 'Executive : 29€/mois pour 1 agent personnalisé + 7 jours gratuits. Teams : 49€/mois par agent pour espace collaboratif d'équipe. Business : 299€/mois pour serveur privé dédié avec agents illimités. Tous les plans évoluent et sont résiliables à tout moment.' },
