...
const T = {
  fr: {
    ...
    lead: 'Travaillez avec un Collaborateur IA qui rejoint votre équipe et augmente les capacités de votre entreprise.',
  ...
  en: {
    ...
    lead: "Work with an AI Collaborator that joins your team and expands your company's capabilities.",
