...
const T = {
  fr: {
    ...
    subheadline:
      'Avec un nom, un rôle, une mémoire. Donnez-lui des objectifs. Il travaille seul ou avec votre équipe, 24h/24.',
  ...
  en: {
    ...
    subheadline:
      'With a name, a role, a memory. Give it objectives. It works alone or with your team, 24/7.',
