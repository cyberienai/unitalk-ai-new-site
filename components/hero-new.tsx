...
const T = {
  fr: {
    ...
    lead: 'Autonome et doté de Profils métier illimités, il travaille avec vos outils et appartient à votre organisation.',
    domainLabel: 'Entrez votre domaine. Alma analyse votre activité et prépare ses premiers Profils.',
  ...
  en: {
    ...
    lead: 'Autonomous and equipped with unlimited job Profiles, it works with your tools and belongs to your organization.',
    domainLabel: 'Enter your domain. Alma analyzes your business and prepares its first Profiles.',
