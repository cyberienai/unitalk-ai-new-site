...
const T = {
  fr: {
    ...
    headline: 'Ajoutez des Collaborateurs IA à votre',
    headlineAccent: ' organigramme.',
    subheadline: 'Augmentez les capacités de votre entreprise.',
    subheadlineAccent: ' Pas vos effectifs.',
    lead: [
      "Chaque dirigeant a des ambitions. Mais toutes les entreprises finissent par rencontrer la même limite : leurs capacités.",
      "Plus de clients. Plus de demandes. Plus de projets. Plus d'opportunités. Mais pas plus de temps, ni de compétences, ni de ressources.",
      "Aujourd'hui, il existe une nouvelle façon de développer une entreprise. Sans recruter davantage.",
    ],
  ...
  en: {
    ...
    headline: 'Add AI Collaborators to your',
    headlineAccent: ' org chart.',
    subheadline: 'Grow your company capabilities.',
    subheadlineAccent: ' Not your headcount.',
    lead: [
      'Every leader has ambitions. But every company eventually hits the same limit: its capacity.',
      'More clients. More requests. More projects. More opportunities. But no more time, skills or resources.',
      'Today, there is a new way to grow a company. Without hiring more.',
    ],
