...
const T = {
  fr: {
    ...
    domainLabel: 'Entrez votre domaine. Alma analyse votre activité et prépare les premiers Profils de votre Collaborateur IA.',
  ...
  en: {
    ...
    domainLabel: 'Enter your domain. Alma analyzes your business and prepares the first Profiles of your AI Collaborator.',
