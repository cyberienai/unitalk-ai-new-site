...
const T = {
  fr: {
    ...
    lead: 'Ajoutez des Collaborateurs IA qui travaillent aux côtés de vos équipes.',
    heroCta: 'Créer votre Collaborateur',
  ...
  en: {
    ...
    lead: 'Add AI Collaborators that work alongside your teams.',
    heroCta: 'Create your Collaborator',
