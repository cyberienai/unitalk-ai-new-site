...
const T = {
  fr: {
    ...
    subheadline:
      "Ils répondent à vos clients, avancent vos dossiers et appartiennent à votre entreprise.",
    summary:
  ...
  en: {
    ...
    subheadline:
      'They answer your customers, move your work forward and belong to your company.',
    summary:
