...
const T = {
  fr: {
    ...
    lead: 'Pendant 7 jours, travaillez avec un Collaborateur IA qui rejoint votre équipe et augmente les capacités de votre entreprise.',
  ...
  en: {
    ...
    lead: "For 7 days, work with an AI Collaborator that joins your team and expands your company's capabilities.",
