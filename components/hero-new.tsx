...
const T = {
  fr: {
    ...
    lead: 'Ajoutez des Collaborateurs IA qui travaillent avec vos équipes pour développer votre entreprise.',
  ...
  en: {
    ...
    lead: 'Add AI Collaborators that work with your teams to grow your business.',
