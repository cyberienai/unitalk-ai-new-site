...
const T = {
  fr: {
    ...
    subheadline:
      "Ils répondent à vos clients, exécutent vos processus, mènent à bien vos projets et développent leurs compétences aux côtés de vos équipes.",
    summary:
  ...
  en: {
    ...
    subheadline:
      'They answer your customers, run your processes, deliver your projects and grow their skills alongside your teams.',
    summary:
