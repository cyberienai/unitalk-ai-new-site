...
export function WorkspaceFinalContent({ onboarding }: { onboarding?: WorkspaceOnboarding }) {
  ...
  return (
    <main className="overflow-hidden bg-[#F3EFE6] font-sf text-[#1C1A17]">
      ...
      <section className="px-5 py-16 sm:px-8 sm:py-24">
        <div className="editorial-shell">
          <div className="grid gap-10 lg:grid-cols-[.72fr_1.28fr] lg:items-end"><div><Kicker>{t.spacesKicker}</Kicker><h2 className="mt-5 text-balance text-[clamp(2.4rem,4.5vw,4.5rem)] font-semibold leading-[.95] tracking-[-.06em]">{t.spacesTitle}</h2></div><p className="max-w-2xl text-[15px] leading-7 text-[#625B50]">{t.spacesLead}</p></div>
...
const COPY = {
  fr: {
    ...
    spacesKicker: 'Espaces de collaboration', spacesTitle: 'Un Workspace pour tous les membres autorisés.', spacesLead: 'Un humain peut utiliser les Assistants IA partagés, participer aux missions et valider des actions sans disposer de son propre Collaborateur IA.',
    spaces: [
  ...
  en: {
    ...
    spacesKicker: 'Collaboration spaces', spacesTitle: 'One Workspace for every authorized member.', spacesLead: 'A human can use shared AI Assistants, participate in missions and approve actions without having their own AI Collaborator.',
    spaces: [
