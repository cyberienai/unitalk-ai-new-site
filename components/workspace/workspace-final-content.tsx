  ...
  return (
    <main id="main-content" className="overflow-hidden bg-[#F3EFE6] font-sf text-[#1C1A17]">
        ...
        <div className="editorial-shell relative grid items-end gap-12 lg:grid-cols-[1.05fr_.95fr] lg:gap-20">
          <div>
            <Kicker>Unitalk Workspace</Kicker>
             <h1 className="mt-5 max-w-4xl text-balance text-[clamp(2.65rem,12vw,4.75rem)] font-semibold leading-[.92] tracking-[-.06em] lg:text-[clamp(3.25rem,5vw,4.75rem)]"><span className="block">{heroLines[0]}</span>{heroLines[1] && <span className="block text-[#D10E63]">{heroLines[1]}</span>}</h1>
          </div>
          <div className="pb-1">
            ...
            {onboarding && <p className="mt-5 text-xs font-semibold text-[#6E665A]">{t.onboardingNote}</p>}
          </div>
        </div>
      </section>
      ...
      <section id="workspace-demo" className="bg-[#151310] px-5 py-14 text-white sm:px-8 sm:py-20">
        <div className="editorial-shell">
          <div className="grid gap-8 lg:grid-cols-[.9fr_1.1fr] lg:items-end">
            <div>
              <Kicker dark>{onboarding ? t.genericDemo : t.demoKicker}</Kicker>
              <WorkspaceSectionTitle title={t.demoTitle} accent={t.demoAccent} dark />
          ...
          <div className="mt-4 text-xs text-[#AFA69A]">
            <p>{t.videoCaption}</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 py-16 sm:px-8 sm:py-24">
        <div className="editorial-shell">
          <div className="max-w-3xl"><Kicker>{t.capabilitiesKicker}</Kicker><WorkspaceSectionTitle title={t.capabilitiesTitle} accent={t.capabilitiesAccent}/><p className="mt-5 text-[16px] leading-8 text-[#625B50]">{t.capabilitiesLead}</p></div>
      ...
      <section className="border-t border-[#D8D0C2] bg-[#FAF8F3] px-5 py-16 sm:px-8 sm:py-20">
        <div className="editorial-shell grid gap-10 lg:grid-cols-[.8fr_1.2fr] lg:items-start lg:gap-20">
          <div><Kicker>{t.downloadKicker}</Kicker><WorkspaceSectionTitle title={t.downloadTitle} accent={t.downloadAccent}/><p className="mt-5 max-w-xl text-[15px] leading-7 text-[#625B50]">{t.downloadLead}</p></div>
      ...
      <section className="px-5 py-16 sm:px-8 sm:py-24">
        <div className="editorial-shell">
          <div className="grid gap-10 lg:grid-cols-[.72fr_1.28fr] lg:items-end"><div><Kicker>{t.spacesKicker}</Kicker><WorkspaceSectionTitle title={t.spacesTitle} accent={t.spacesAccent}/></div><p className="max-w-2xl text-[15px] leading-7 text-[#625B50]">{t.spacesLead}</p></div>
      ...
      <section className="border-y border-[#D8D0C2] bg-[#EAE3D4] px-5 py-16 sm:px-8 sm:py-20">
        <div className="editorial-shell grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-20">
          <div><Kicker>{t.governanceKicker}</Kicker><WorkspaceSectionTitle title={t.governanceTitle} accent={t.governanceAccent}/><p className="mt-5 text-[15px] leading-7 text-[#625B50]">{t.governanceLead}</p></div>
        ...
        <div className="editorial-shell grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
          <div className="max-w-4xl">
            <Kicker>{t.freeKicker}</Kicker>
             <WorkspaceSectionTitle title={t.freeTitle} accent={t.freeAccent}/>
      ...
      <section className="bg-[#151310] px-5 py-16 text-white sm:px-8 sm:py-20">
        <div className="editorial-shell">
          <div className="max-w-3xl"><Kicker dark>{t.rolesKicker}</Kicker><WorkspaceSectionTitle title={t.rolesTitle} accent={t.rolesAccent} dark/></div>
      ...
      <section className="px-5 py-16 sm:px-8 sm:py-20">
        <div className="editorial-shell flex flex-col items-start justify-between gap-8 rounded-[24px] border border-[#D8D0C2] bg-[#FAF8F3] p-7 sm:p-10 lg:flex-row lg:items-end">
          <div className="max-w-3xl"><Kicker>{t.finalKicker}</Kicker><WorkspaceSectionTitle title={t.finalTitle} accent={t.finalAccent}/><p className="mt-5 max-w-2xl text-[16px] leading-7 text-[#4E483F]">{t.finalBody}</p><p className="mt-5 text-sm font-semibold"><AlmaInline /> Alma · {t.almaRole}</p></div>
          <div className="flex flex-col items-stretch gap-4"><CtaButton href={localizedHref('missions', lang)}>{t.finalCta}<ArrowRight className="size-4" /></CtaButton><Link href={localizedHref('pricing', lang)} className="text-center text-sm font-bold underline decoration-[#D10E63]/30 underline-offset-4">{t.pricing}</Link></div>
        </div>
      </section>
    </main>
  )
...
function WorkspaceSectionTitle({ title, accent, dark = false }: { title: string; accent: string; dark?: boolean }) {
  return <h2 className="mt-5 max-w-4xl text-balance text-[clamp(2.35rem,4vw,3.5rem)] font-bold leading-[.98] tracking-[-.05em]"><span>{title}</span>{' '}<span className={dark ? 'text-[#F15B9B]' : 'text-[#D10E63]'}>{accent}</span></h2>
}
...
const COPY = {
  fr: {
    ...
    demoNote: 'Unitalk transforme ces capacités open source en un environnement de travail partagé, où missions, accès et décisions restent gouvernés par votre entreprise.',
    videoLabel: 'Démonstration vidéo du projet Hermes Desktop', videoCaption: 'Démonstration officielle du projet open source Hermes Desktop par Nous Research. Unitalk Desktop en est une distribution enrichie.',
    freeKicker: 'Commencez gratuitement', freeTitle: 'Votre Workspace Solo est gratuit.', freeAccent: 'Votre première mission aussi.', freeBody: 'Alma configure l’accès aux modèles IA, prépare la synchronisation avec Unitalk AI Cloud et vous accompagne jusqu’à la première mission de votre Collaborateur IA.', freeCta: 'Créer mon Workspace Solo',
    capabilitiesKicker: 'Les capacités du moteur', capabilitiesTitle: 'Six capacités agentiques.', capabilitiesAccent: 'Un cadre Unitalk.', capabilitiesLead: 'Le moteur open source apporte les capacités d’exécution. Unitalk les intègre aux missions et aux règles de votre entreprise.',
    capabilities: [
    ...
    spaces: [
      ['Privé', 'Un espace personnel pour préparer, converser et travailler avant de partager.', ['Assistants ponctuels visibles par vous seul', 'Documents et conversations personnels', 'Ressources accessibles uniquement à leur propriétaire']],
      ['Partagé', 'Un espace d’équipe pour travailler sur les mêmes missions et connaissances autorisées.', ['Assistants ponctuels partagés avec l’équipe', 'Missions, fichiers et commentaires communs', 'Validations visibles par les membres autorisés']],
    ...
    downloadKicker: 'Unitalk Desktop', downloadTitle: 'Unitalk Desktop relie l’exécution', downloadAccent: 'au travail collectif.', downloadLead: 'Unitalk Desktop est la distribution Unitalk du projet open source Hermes Desktop. Elle intègre Unitalk AI Gateway et la synchronisation avec Unitalk AI Cloud afin de réunir l’exécution locale et les services de collaboration de l’entreprise.',
    ...
    governanceKicker: 'Contrôle humain', governanceTitle: 'Autonome dans le cadre.', governanceAccent: 'Jamais hors cadre.', governanceLead: 'Une application n’accorde aucun droit à elle seule. Chaque action dépend des permissions de la mission et des validations définies par votre entreprise.',
    ...
    rolesKicker: 'Une équipe lisible', rolesTitle: 'Chacun garde', rolesAccent: 'son rôle.', humanTitle: 'Votre équipe', humanBody: 'Définit le résultat, apporte le contexte et garde les décisions engageantes.', aiTitle: 'Le Collaborateur IA', aiBody: 'Réalise la mission avec son profil, sa mémoire et les outils autorisés.', almaTitle: 'Alma', almaBody: 'Cadre la mission, prépare le Collaborateur et orchestre les validations.',
    finalKicker: 'Première mission offerte', finalTitle: 'Commencez par', finalAccent: 'un résultat concret.', finalBody: 'Choisissez une mission ou décrivez votre besoin. Alma prépare le Workspace et le Collaborateur IA adapté.', almaRole: 'Coordinatrice de missions IA', finalCta: 'Explorer les missions', pricing: 'Voir les tarifs',
  },
  en: {
    ...
    demoNote: 'Unitalk turns these open-source capabilities into a shared work environment where missions, access and decisions remain governed by your organization.',
    videoLabel: 'Hermes Desktop project video demonstration', videoCaption: 'Official demonstration of the open-source Hermes Desktop project by Nous Research. Unitalk Desktop is an enriched distribution of it.',
    freeKicker: 'Start for free', freeTitle: 'Your Solo Workspace is free.', freeAccent: 'So is your first mission.', freeBody: 'Alma configures access to AI models, prepares synchronization with Unitalk AI Cloud and supports you through your AI Collaborator’s first mission.', freeCta: 'Create my Solo Workspace',
    capabilitiesKicker: 'Engine capabilities', capabilitiesTitle: 'Six agent capabilities.', capabilitiesAccent: 'One Unitalk framework.', capabilitiesLead: 'The open-source engine provides execution capabilities. Unitalk connects them to missions and your organization’s rules.',
    capabilities: [
    ...
    spaces: [
      ['Private', 'A personal space to prepare, converse and work before sharing.', ['One-off assistants visible only to you', 'Personal documents and conversations', 'Resources accessible only to their owner']],
      ['Shared', 'A team space for working on the same missions and authorized knowledge.', ['One-off assistants shared with the team', 'Shared missions, files and comments', 'Approvals visible to authorized members']],
    ...
    downloadKicker: 'Unitalk Desktop', downloadTitle: 'Unitalk Desktop connects execution', downloadAccent: 'to collaborative work.', downloadLead: 'Unitalk Desktop is Unitalk’s distribution of the open-source Hermes Desktop project. It integrates Unitalk AI Gateway and synchronization with Unitalk AI Cloud, combining local execution with organization-wide collaboration services.',
    ...
    governanceKicker: 'Human control', governanceTitle: 'Autonomous within the framework.', governanceAccent: 'Never outside it.', governanceLead: 'An application grants no permission by itself. Every action depends on mission permissions and the approvals defined by your organization.',
    ...
    rolesKicker: 'A legible team', rolesTitle: 'Everyone keeps', rolesAccent: 'a clear role.', humanTitle: 'Your team', humanBody: 'Defines the outcome, provides context and retains consequential decisions.', aiTitle: 'The AI Collaborator', aiBody: 'Performs the mission with its profile, memory and authorized tools.', almaTitle: 'Alma', almaBody: 'Scopes the mission, prepares the Collaborator and orchestrates approvals.',
    finalKicker: 'First mission included', finalTitle: 'Start with', finalAccent: 'a concrete outcome.', finalBody: 'Choose a mission or describe your need. Alma prepares the Workspace and the right AI Collaborator.', almaRole: 'AI mission coordinator', finalCta: 'Explore missions', pricing: 'View pricing',
  },
} as const
