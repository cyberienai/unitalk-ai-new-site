...
describe('onboarding trial confirmation', () => {
  ...
  it('makes trial and activation conditions explicit', () => {
    for (const wording of ['Première mission offerte', '7 jours d’essai', 'Sans carte bancaire', 'Rien ne devient payant sans votre accord', 'Aucune application n’est connectée automatiquement']) expect(source).toContain(wording)
  })
