...
describe('Academy integration',()=>{
  ...
  it('connects a real mission to the Co-creator training and licence',()=>{
    const home=readFileSync(join(root,'app','academy','page.tsx'),'utf8')
    ...
    expect(free).toContain('Créer avec Alma')
    expect(pricing).toContain('La formation et la licence sont deux éléments distincts.')
    expect(pricing).toContain('50 € par mois et par Co-créateur')
  })
