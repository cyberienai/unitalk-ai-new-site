...
describe('site footer', () => {
  it('provides marketplace, platform, resource, company and partner navigation', () => {
    ...
    expect(footer).toContain("['Unitalk AI Cloud', '/marketplace/serveurs-ia']")
    expect(footer).toContain("discoverAlma: 'Découvrir Alma'")
    expect(footer).toContain("localizePublicHref('/collaborateurs-ia/alma', lang)")
  ...
  it('keeps the footer bilingual and localizes public links', () => {
    ...
    expect(footer).toContain("localizePublicHref('/marketplace/serveurs-ia', lang)")
    expect(footer).toContain('href={localizePublicHref(href, lang)}')
