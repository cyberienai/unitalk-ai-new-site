...
export const metadata: Metadata = {
  ...
  description:
    'Explorez 80 profils métier IA prêts à adapter : commercial, support client, direction, marketing, finance, RH et opérations. Alma vous aide à choisir.',
  keywords: [
    'profil métier IA',
  ...
  openGraph: {
    ...
    title: '80 profils métier pour Collaborateurs IA | Unitalk',
    description:
