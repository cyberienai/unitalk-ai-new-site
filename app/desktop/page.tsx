...
export const metadata:Metadata={title:'Unitalk Desktop : votre équipe humain-IA sur ordinateur',description:'Accédez à la distribution Unitalk AI depuis Mac, Windows ou Linux. Confiez des missions, suivez le travail et validez les actions sensibles.',alternates:{canonical:'/desktop',languages:{fr:'/desktop',en:'/en/desktop','x-default':'/desktop'}},openGraph:{type:'website',url:'https://unitalk.ai/desktop',title:'Unitalk Desktop | Unitalk AI',description:'Le poste de travail local de votre équipe humain-IA.'}}
