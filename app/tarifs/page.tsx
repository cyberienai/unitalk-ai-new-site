...
import { PRICING_DRAFT_COOKIE, normalizePricingDraft, parsePricingDraftEnvelope } from '@/lib/unitalk-pricing'
...
export default async function TarifsPage() {
  ...
  const draft = envelope?.draft ?? normalizePricingDraft({})
  return (
    <div className="min-h-screen bg-[#F3EFE6] text-[#1C1A17]">
      <Navbar />
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(faqJsonLd)}} />
      <PricingDraftProvider initialDraft={draft}>
        <main>
