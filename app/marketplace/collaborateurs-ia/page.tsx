...
export const metadata: Metadata = {
  ...
  description: 'Découvrez 10 Collaborateurs IA par métier, choisissez une première mission et ajoutez les profils métier et compétences adaptés à votre entreprise.',
  ...
  openGraph: {
    ...
    title: '10 Collaborateurs IA pour votre entreprise | Unitalk',
    description: 'Comparez leurs domaines, leurs premières missions et les compétences que vous pouvez leur ajouter sans frais supplémentaires.',
...
export default function CollaboratorsMarketplacePage() {
  const itemList = {
    ...
    description: 'Dix Collaborateurs IA spécialisés par domaine métier pour les équipes et les PME.',
    inLanguage: 'fr-FR',
