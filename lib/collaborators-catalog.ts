...
export const ROLE_DETAILS: Record<string, RoleDetail> = {
  ...
  chloe: {
    ...
    promise: { fr: 'Transforme vos besoins de recrutement en candidatures qualifiées.', en: 'Turns hiring needs into qualified applicants.' },
  ...
  lucas: {
    ...
    promise: { fr: 'Garde vos projets, échéances et responsables parfaitement alignés.', en: 'Keeps projects, deadlines and owners perfectly aligned.' },
  ...
  camille: {
    ...
    promise: { fr: 'Transforme les signaux du marché en scénarios et décisions mieux préparés.', en: 'Turns market signals into scenarios and better-prepared decisions.' },
  ...
  sophia: {
    ...
    promise: { fr: 'Prépare des dossiers complets et maintient vos échéances administratives.', en: 'Prepares complete files and maintains administrative deadlines.' },
  ...
  otto: {
    ...
    promise: { fr: 'Prépare vos factures et relances sans perdre un justificatif.', en: 'Prepares invoices and reminders without losing a receipt.' },
  ...
  alex: {
    ...
    promise: { fr: 'Transforme vos objectifs de croissance en campagnes mesurables.', en: 'Turns growth goals into measurable campaigns.' },
  ...
  iris: {
    ...
    promise: { fr: 'Relie les besoins utilisateurs, la roadmap et la qualité des livraisons.', en: 'Connects user needs, roadmap and release quality.' },
  ...
  marcus: {
    ...
    promise: { fr: 'Rend vos contrats, échéances et preuves de conformité pilotables.', en: 'Makes contracts, deadlines and compliance evidence manageable.' },
  ...
  amelia: {
    ...
    promise: { fr: 'Détecte les risques plus tôt et prépare chaque action de fidélisation.', en: 'Detects risks earlier and prepares every retention action.' },
  ...
  maya: {
    ...
    promise: { fr: 'Anime vos réseaux avec un calendrier cohérent et des réponses maîtrisées.', en: 'Runs your social channels with a consistent calendar and controlled replies.' },
  ...
  noah: {
    ...
    promise: { fr: 'Transforme vos données dispersées en indicateurs fiables et compréhensibles.', en: 'Turns scattered data into reliable, understandable metrics.' },
  ...
  victor: {
    ...
    promise: { fr: 'Prépare des déploiements fiables et rend les incidents plus rapides à résoudre.', en: 'Prepares reliable deployments and makes incidents faster to resolve.' },
  ...
  sarah: {
    ...
    promise: { fr: 'Transforme chaque incident client en diagnostic clair et actionnable.', en: 'Turns every customer incident into a clear, actionable diagnosis.' },
  ...
  gabriel: {
    ...
    promise: { fr: 'Fiabilise vos choix fournisseurs, vos contrats et le pilotage de vos dépenses.', en: 'Strengthens supplier selection, contracts and spend management.' },
  ...
  zoe: {
    ...
    promise: { fr: 'Rend chaque arrivée plus fluide et chaque échéance RH plus visible.', en: 'Makes every arrival smoother and every HR deadline more visible.' },
