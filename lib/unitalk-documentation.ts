...
export const DOCUMENTATION: Record<DocumentationSlug, DocumentationPage> = {
  'alma-organisation': {
    slug:'alma-organisation',number:'01',eyebrow:'Licence de contrôle',title:'Licence Entreprise',price:'0 à 299 €/mois',included:'Forfait par entreprise, jamais par siège',summary:'Le cadre de gestion de votre entreprise : Assistants IA illimités, Workspace, applications, modèles, membres, budgets et gouvernance.',principle:'La Licence Entreprise gouverne les ressources disponibles. Elle ne crée pas automatiquement des ressources individuelles pour chaque Collaborateur IA.',
    sections:[
  ...
  'capacite-ia': {
    ...
    sections:[{title:'BYOK',items:['Clés propres de l’entreprise','Usage facturé par le fournisseur','Gouvernance par Unitalk AI Gateway','Aucun quota Unitalk facturé']},{title:'Crédits prépayés',items:['Recharge à partir de 25 €','Modèles IA et usages multimodaux','API externes et téléphone','Aucun dépassement sans validation']},{title:'Mode hybride',items:['Clés propres lorsque disponibles','Crédits Unitalk pour les autres services','Budget partagé par l’entreprise','Consommation suivie']}],distinctions:[{organization:'Modèles et fournisseurs autorisés',collaborator:'Modèles utilisables'},{organization:'Coffre de clés API',collaborator:'Accès indirect selon les droits'},{organization:'Budgets et quotas',collaborator:'Consommation attribuée'}],related:['alma-organisation','licence-collaborateur-ia'],
  },
  'co-createur-ia': {
