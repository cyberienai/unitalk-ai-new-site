...
const SERVERS: StoreItem[] = [
  ...
  { type: 'server', slug: 'medium', name: { fr: 'Medium', en: 'Medium' }, description: { fr: 'Serveur Unitalk AI Cloud pour des missions régulières et plusieurs applications connectées.', en: 'Unitalk AI Cloud server for regular workloads and multiple connected applications.' }, creator: 'unitalk', facet: 'unitalk-ai-cloud', enables: [{ fr: '2 CPU', en: '2 CPUs' }], contexts: [{ fr: 'Usage régulier et charge intermédiaire', en: 'Regular use and moderate workloads' }], permissions: [{ fr: 'Configuration gérée par Unitalk', en: 'Configuration managed by Unitalk' }], order: 1, dateAdded: '2026-08-16', keywords: ['medium','2 cpu','unitalk ai cloud'], commercialStatus: 'draft' },
  { type: 'server', slug: 'large', name: { fr: 'Large', en: 'Large' }, description: { fr: 'Serveur accéléré pour les modèles exigeants, les automatisations continues et les équipes en production.', en: 'Accelerated server for demanding models, continuous automation and production teams.' }, creator: 'unitalk', facet: 'unitalk-ai-cloud', enables: [{ fr: '4 GPU', en: '4 GPUs' }], contexts: [{ fr: 'Production et traitements accélérés', en: 'Production and accelerated workloads' }], permissions: [{ fr: 'Architecture et capacité validées avant activation', en: 'Architecture and capacity approved before activation' }], order: 2, dateAdded: '2026-08-16', keywords: ['large','4 gpu','unitalk ai cloud'], commercialStatus: 'draft' },
  { type: 'server', slug: 'xl', name: { fr: 'XL', en: 'XL' }, description: { fr: 'Infrastructure GPU dédiée aux charges soutenues et à plusieurs Collaborateurs IA.', en: 'Dedicated GPU infrastructure for sustained workloads and multiple AI Collaborators.' }, creator: 'unitalk', facet: 'unitalk-ai-cloud', enables: [{ fr: '8 GPU', en: '8 GPUs' }], contexts: [{ fr: 'Forte charge et exploitation multi-collaborateurs', en: 'Heavy workloads and multi-collaborator operations' }], permissions: [{ fr: 'Architecture et capacité validées sur étude', en: 'Architecture and capacity approved after assessment' }], order: 3, dateAdded: '2026-08-16', keywords: ['xl','8 gpu','unitalk ai cloud'], commercialStatus: 'draft' },
  { type: 'server', slug: 'xxl', name: { fr: 'XXL', en: 'XXL' }, description: { fr: 'Infrastructure GPU de très grande capacité pour les déploiements critiques et les volumes élevés.', en: 'Very high-capacity GPU infrastructure for critical deployments and high volumes.' }, creator: 'unitalk', facet: 'unitalk-ai-cloud', enables: [{ fr: '16 GPU', en: '16 GPUs' }], contexts: [{ fr: 'Déploiement critique ou à grande échelle', en: 'Critical or large-scale deployment' }], permissions: [{ fr: 'Architecture, hébergement et conditions définis sur étude', en: 'Architecture, hosting and terms defined after assessment' }], order: 4, dateAdded: '2026-08-16', keywords: ['xxl','16 gpu','unitalk ai cloud'], commercialStatus: 'draft' },
]
