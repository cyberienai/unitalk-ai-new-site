...
const SERVERS: StoreItem[] = [
  ...
  { type: 'server', slug: 'large', name: { fr: 'Serveur privé Large', en: 'Large private server' }, description: { fr: 'Pour plusieurs Collaborateurs IA, des automatisations continues et des applications plus exigeantes.', en: 'For several AI Collaborators, continuous automations and more demanding applications.' }, creator: 'unitalk', facet: 'infrastructure', enables: [{ fr: 'Soutenir une exploitation multi-collaborateurs', en: 'Support multi-collaborator operations' }], contexts: [{ fr: 'Entreprise structurée, charge soutenue', en: 'Structured organization, sustained workload' }], permissions: [{ fr: 'Architecture et capacité confirmées sur étude', en: 'Architecture and capacity confirmed after assessment' }], order: 2, dateAdded: '2026-08-16', keywords: ['serveur','large','privé','entreprise'], commercialStatus: 'draft' },
