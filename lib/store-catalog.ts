...
const SERVERS: StoreItem[] = [
  { type: 'server', slug: 'small', name: { fr: 'Unitalk Cloud', en: 'Unitalk Cloud' }, description: { fr: 'Infrastructure mutualisée et sécurisée pour démarrer avec des missions légères et des applications peu exigeantes.', en: 'Secure shared infrastructure for getting started with light missions and low-demand applications.' }, creator: 'unitalk', facet: 'infrastructure', enables: [{ fr: 'Héberger un premier environnement géré', en: 'Host a first managed environment' }], contexts: [{ fr: 'Inclus pour démarrer, petite équipe, faible charge', en: 'Included to get started, small team, light workload' }], permissions: [{ fr: 'Configuration gérée et validée avant activation', en: 'Managed configuration approved before activation' }], order: 0, dateAdded: '2026-08-16', keywords: ['unitalk cloud','serveur','mutualisé','sécurisé','pilote'], commercialStatus: 'draft' },
  { type: 'server', slug: 'medium', name: { fr: 'Serveur IA dédié', en: 'Dedicated AI server' }, description: { fr: 'Une infrastructure d’exécution dédiée à votre entreprise, pour plusieurs applications et des missions régulières.', en: 'Execution infrastructure dedicated to your company, for several applications and regular missions.' }, creator: 'unitalk', facet: 'infrastructure', enables: [{ fr: 'Faire fonctionner plusieurs services métier sur des ressources dédiées', en: 'Run several business services on dedicated resources' }], contexts: [{ fr: 'Upgrade pour équipe en production et charge régulière', en: 'Upgrade for a production team and regular workload' }], permissions: [{ fr: 'Configuration dimensionnée et validée avant activation', en: 'Configuration sized and approved before activation' }], order: 1, dateAdded: '2026-08-16', keywords: ['serveur ia dédié','upgrade','privé','équipe'], commercialStatus: 'draft' },
  { type: 'server', slug: 'large', name: { fr: 'Infrastructure privée avancée', en: 'Advanced private infrastructure' }, description: { fr: 'Pour plusieurs Collaborateurs IA, des automatisations continues et des applications plus exigeantes.', en: 'For several AI Collaborators, continuous automations and more demanding applications.' }, creator: 'unitalk', facet: 'infrastructure', enables: [{ fr: 'Augmenter les ressources d’une exploitation multi-collaborateurs', en: 'Scale resources for multi-collaborator operations' }], contexts: [{ fr: 'Upgrade pour entreprise structurée et charge soutenue', en: 'Upgrade for a structured company and sustained workload' }], permissions: [{ fr: 'Architecture et capacité confirmées sur étude', en: 'Architecture and capacity confirmed after assessment' }], order: 2, dateAdded: '2026-08-16', keywords: ['infrastructure privée','upgrade','serveur','entreprise'], commercialStatus: 'draft' },
