...
//
// Each mission is authored as a compact SEED; buildMission() derives the richer detail-page fields
...
export const MISSION_CATEGORIES: MissionCategory[] = [
  ...
  { key: 'administration', label: { fr: 'Administration & entreprise', en: 'Administration & organization' } },
...
export const MISSION_COLLECTIONS: MissionCollection[] = [
  ...
  { key: 'piloter-organisation', label: { fr: "Piloter l'entreprise", en: 'Steer the organization' } },
...
const SEEDS: Seed[] = [
  ...
  m('analyse', 'preparer-une-etude-de-marche', 'Préparer une étude de marché', 'Prepare a market study', 'Un dossier structuré sur le marché, les clients et les principaux acteurs.', 'A structured file on the market, customers and key players.', { collaboratorSlug: 'camille' }),
  m('analyse', 'suivre-les-actualites-d-un-secteur', 'Suivre les actualités d’un secteur', 'Track industry news', 'Une sélection qualifiée des informations ayant un impact potentiel.', 'A qualified selection of news with potential impact.', { collaboratorSlug: 'camille' }),
  ...
  // Chloé · Recrutement
  m('rh', 'chloe-definir-le-besoin-de-recrutement', 'Définir un besoin de recrutement', 'Define a hiring need', 'Un brief de poste clarifiant responsabilités, critères et contraintes.', 'A role brief clarifying responsibilities, criteria and constraints.', { collaboratorSlug: 'chloe' }),
  m('rh', 'chloe-rediger-une-offre-emploi', 'Rédiger une offre d’emploi', 'Write a job posting', 'Une offre claire, inclusive et prête à être validée par l’équipe RH.', 'A clear, inclusive job posting ready for HR approval.', { collaboratorSlug: 'chloe' }),
  m('rh', 'chloe-preparer-une-campagne-de-sourcing', 'Préparer une campagne de sourcing', 'Prepare a sourcing campaign', 'Les cibles, canaux et messages d’approche sont structurés.', 'Targets, channels and outreach messages are structured.', { collaboratorSlug: 'chloe' }),
  m('rh', 'chloe-sourcer-des-candidats', 'Sourcer des candidats', 'Source candidates', 'Une sélection de profils correspondant aux critères validés.', 'A selection of profiles matching the approved criteria.', { collaboratorSlug: 'chloe' }),
  m('rh', 'chloe-preselectionner-les-candidatures', 'Présélectionner les candidatures', 'Shortlist applications', 'Une présélection argumentée et comparable à partir des critères autorisés.', 'A justified, comparable shortlist based on authorized criteria.', { collaboratorSlug: 'chloe' }),
  m('rh', 'chloe-analyser-les-cv', 'Analyser les CV', 'Analyze resumes', 'Les expériences et compétences déclarées sont synthétisées sans décision automatique.', 'Declared experience and skills are summarized without automated decisions.', { collaboratorSlug: 'chloe' }),
  m('rh', 'chloe-preparer-les-entretiens', 'Préparer les entretiens', 'Prepare interviews', 'Un dossier candidat et une trame de questions adaptés au poste.', 'A candidate brief and question guide tailored to the role.', { collaboratorSlug: 'chloe' }),
  m('rh', 'chloe-organiser-les-entretiens', 'Organiser les entretiens', 'Schedule interviews', 'Les disponibilités, invitations et confirmations sont coordonnées.', 'Availability, invitations and confirmations are coordinated.', { collaboratorSlug: 'chloe', modality: 'automatisation' }),
  m('rh', 'chloe-synthetiser-les-entretiens', 'Synthétiser les entretiens', 'Summarize interviews', 'Les observations sont structurées selon la grille validée par l’équipe.', 'Observations are structured using the team-approved scorecard.', { collaboratorSlug: 'chloe' }),
  m('rh', 'chloe-preparer-une-proposition-embauche', 'Préparer une proposition d’embauche', 'Prepare an employment offer', 'Les éléments de la proposition sont réunis pour validation humaine.', 'Offer elements are gathered for human approval.', { collaboratorSlug: 'chloe' }),
  m('rh', 'chloe-preparer-arrivee-collaborateur', 'Préparer l’arrivée d’un collaborateur', 'Prepare an employee’s arrival', 'Le parcours, les documents et les rendez-vous d’intégration sont prêts.', 'The onboarding journey, documents and meetings are ready.', { collaboratorSlug: 'chloe' }),
  m('rh', 'chloe-suivre-integration-collaborateur', 'Suivre l’intégration d’un collaborateur', 'Track employee onboarding', 'Les étapes, retours et points de blocage sont consolidés.', 'Steps, feedback and blockers are consolidated.', { collaboratorSlug: 'chloe' }),

  // Lucas · Opérations
  m('operations', 'lucas-mettre-a-jour-un-plan-de-projet', 'Mettre à jour un plan de projet', 'Update a project plan', 'Les jalons, responsables et dépendances sont actualisés.', 'Milestones, owners and dependencies are updated.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-suivre-un-projet-transverse', 'Suivre un projet transverse', 'Track a cross-functional project', 'Une vue partagée des échéances, responsables, risques et décisions.', 'A shared view of deadlines, owners, risks and decisions.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-preparer-un-comite-de-suivi', 'Préparer un comité de suivi', 'Prepare a steering meeting', 'Un dossier synthétique présente avancement, blocages et arbitrages.', 'A concise pack presents progress, blockers and decisions.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-rediger-un-compte-rendu-projet', 'Rédiger un compte rendu de projet', 'Write a project update', 'Les décisions, actions et échéances sont structurées et attribuées.', 'Decisions, actions and deadlines are structured and assigned.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-relancer-les-actions-en-retard', 'Relancer les actions en retard', 'Follow up on overdue actions', 'Des rappels contextualisés sont préparés pour chaque responsable.', 'Contextual reminders are prepared for each owner.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-cartographier-les-dependances', 'Cartographier les dépendances', 'Map dependencies', 'Les dépendances critiques et leurs impacts potentiels sont visibles.', 'Critical dependencies and their potential impact are visible.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-suivre-les-risques-projet', 'Suivre les risques projet', 'Track project risks', 'Un registre actualisé présente risques, niveaux et mesures prévues.', 'An updated register presents risks, levels and planned measures.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-coordonner-un-lancement', 'Coordonner un lancement', 'Coordinate a launch', 'Les étapes, équipes et validations du lancement sont alignées.', 'Launch steps, teams and approvals are aligned.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-preparer-un-planning-operationnel', 'Préparer un planning opérationnel', 'Prepare an operations schedule', 'Les activités, capacités et échéances sont organisées dans un planning partagé.', 'Activities, capacity and deadlines are organized in a shared schedule.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-documenter-un-processus', 'Documenter un processus', 'Document a process', 'Les étapes, rôles, entrées et contrôles sont clairement décrits.', 'Steps, roles, inputs and controls are clearly described.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-analyser-les-blocages', 'Analyser les blocages opérationnels', 'Analyze operational blockers', 'Les causes, impacts et options de résolution sont consolidés.', 'Causes, impacts and resolution options are consolidated.', { collaboratorSlug: 'lucas' }),
  m('operations', 'lucas-preparer-un-rapport-operations', 'Préparer un rapport d’opérations', 'Prepare an operations report', 'Une synthèse des volumes, délais, incidents et priorités est prête.', 'A summary of volumes, delays, incidents and priorities is ready.', { collaboratorSlug: 'lucas', modality: 'donnees' }),

  // Iris · Produit
  m('produit', 'iris-synthetiser-les-retours-utilisateurs', 'Synthétiser les retours utilisateurs', 'Synthesize user feedback', 'Les besoins, irritants et demandes sont regroupés par thème et priorité.', 'Needs, pain points and requests are grouped by theme and priority.', { collaboratorSlug: 'iris', modality: 'donnees' }),
  m('produit', 'iris-preparer-une-specification-produit', 'Préparer une spécification produit', 'Prepare a product specification', 'Le besoin, les comportements et critères d’acceptation sont structurés.', 'The need, behaviors and acceptance criteria are structured.', { collaboratorSlug: 'iris' }),
  m('produit', 'iris-rediger-des-recits-utilisateurs', 'Rédiger des récits utilisateurs', 'Write user stories', 'Des récits utilisateurs testables sont accompagnés de critères de validation.', 'Testable user stories include validation criteria.', { collaboratorSlug: 'iris' }),
  m('produit', 'iris-prioriser-un-backlog', 'Prioriser un backlog', 'Prioritize a backlog', 'Une proposition de priorité relie valeur, effort, risque et dépendances.', 'A priority proposal connects value, effort, risk and dependencies.', { collaboratorSlug: 'iris' }),
  m('produit', 'iris-preparer-une-roadmap', 'Préparer une roadmap produit', 'Prepare a product roadmap', 'Les initiatives sont ordonnées selon les objectifs et contraintes validés.', 'Initiatives are sequenced against approved goals and constraints.', { collaboratorSlug: 'iris' }),
  m('produit', 'iris-construire-un-plan-de-recette', 'Construire un plan de recette', 'Build a test plan', 'Les scénarios nominaux, cas limites et critères de réussite sont documentés.', 'Happy paths, edge cases and success criteria are documented.', { collaboratorSlug: 'iris' }),
  m('produit', 'iris-preparer-une-recherche-utilisateur', 'Préparer une recherche utilisateur', 'Prepare user research', 'Les objectifs, profils, questions et méthode de restitution sont cadrés.', 'Objectives, profiles, questions and reporting method are scoped.', { collaboratorSlug: 'iris' }),
  m('produit', 'iris-analyser-une-interface', 'Analyser une interface', 'Analyze an interface', 'Les problèmes de compréhension, accessibilité et conversion sont documentés.', 'Comprehension, accessibility and conversion issues are documented.', { collaboratorSlug: 'iris' }),
  m('produit', 'iris-preparer-un-brief-design', 'Préparer un brief design', 'Prepare a design brief', 'Le problème, le parcours, les contraintes et résultats attendus sont clarifiés.', 'The problem, journey, constraints and expected outcomes are clarified.', { collaboratorSlug: 'iris' }),
  m('produit', 'iris-analyser-les-indicateurs-produit', 'Analyser les indicateurs produit', 'Analyze product metrics', 'Les évolutions, anomalies et hypothèses à examiner sont mises en évidence.', 'Changes, anomalies and hypotheses to examine are highlighted.', { collaboratorSlug: 'iris', modality: 'donnees' }),
  m('produit', 'iris-preparer-une-revue-produit', 'Préparer une revue produit', 'Prepare a product review', 'Une synthèse relie résultats, retours, roadmap et décisions attendues.', 'A summary connects outcomes, feedback, roadmap and expected decisions.', { collaboratorSlug: 'iris' }),
  m('produit', 'iris-documenter-une-livraison', 'Documenter une livraison produit', 'Document a product release', 'Les changements, impacts, limites et consignes sont prêts à communiquer.', 'Changes, impacts, limits and guidance are ready to communicate.', { collaboratorSlug: 'iris' }),

  // Marcus · Juridique et conformité
  m('documents', 'marcus-cartographier-les-contrats-actifs', 'Cartographier les contrats actifs', 'Map active contracts', 'Un inventaire structuré présente parties, objets, échéances et responsables.', 'A structured inventory presents parties, purpose, deadlines and owners.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-preparer-une-revue-de-contrat', 'Préparer une revue de contrat', 'Prepare a contract review', 'Les clauses, échéances et points à soumettre au juriste sont isolés.', 'Clauses, deadlines and points for legal review are isolated.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-comparer-deux-versions-de-contrat', 'Comparer deux versions de contrat', 'Compare two contract versions', 'Les modifications et leurs conséquences possibles sont clairement présentées.', 'Changes and their potential implications are clearly presented.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-extraire-les-clauses-cles', 'Extraire les clauses clés', 'Extract key clauses', 'Les clauses recherchées sont structurées avec leur emplacement et leur source.', 'Requested clauses are structured with their location and source.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-suivre-les-echeances-contractuelles', 'Suivre les échéances contractuelles', 'Track contract deadlines', 'Les renouvellements, préavis et obligations sont identifiés avant échéance.', 'Renewals, notice periods and obligations are identified before deadlines.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-preparer-un-dossier-de-signature', 'Préparer un dossier de signature', 'Prepare a signature package', 'Les documents, signataires et contrôles préalables sont réunis.', 'Documents, signatories and preliminary checks are gathered.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-mettre-a-jour-le-registre-rgpd', 'Mettre à jour le registre RGPD', 'Update the GDPR register', 'Les traitements, finalités, bases et durées sont structurés pour validation.', 'Processing activities, purposes, bases and retention periods are structured for review.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-preparer-une-analyse-de-conformite', 'Préparer une analyse de conformité', 'Prepare a compliance review', 'Les exigences, preuves disponibles et écarts à traiter sont documentés.', 'Requirements, available evidence and gaps to address are documented.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-cartographier-les-donnees-personnelles', 'Cartographier les données personnelles', 'Map personal data', 'Les données, flux, accès et durées de conservation sont recensés.', 'Data, flows, access and retention periods are inventoried.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-preparer-une-reponse-droits-rgpd', 'Préparer une réponse à une demande RGPD', 'Prepare a GDPR rights response', 'Le dossier et le projet de réponse sont préparés pour validation juridique.', 'The case file and draft response are prepared for legal approval.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-suivre-les-preuves-de-conformite', 'Suivre les preuves de conformité', 'Track compliance evidence', 'Une vue actualisée relie exigences, documents, responsables et échéances.', 'An updated view connects requirements, documents, owners and deadlines.', { collaboratorSlug: 'marcus', regulated: true }),
  m('documents', 'marcus-preparer-un-dossier-audit', 'Préparer un dossier d’audit', 'Prepare an audit file', 'Les politiques, preuves et points ouverts sont réunis dans un dossier traçable.', 'Policies, evidence and open points are gathered in a traceable file.', { collaboratorSlug: 'marcus', regulated: true }),

  // Gabriel · Achats (3 missions existent déjà dans les catégories Finance et Opérations)
  m('finance', 'gabriel-rechercher-des-fournisseurs', 'Rechercher des fournisseurs', 'Research suppliers', 'Une première liste de fournisseurs documentée selon les critères validés.', 'An initial supplier list documented against approved criteria.', { collaboratorSlug: 'gabriel' }),
  m('finance', 'gabriel-qualifier-des-fournisseurs', 'Qualifier des fournisseurs', 'Qualify suppliers', 'Les capacités, références, conditions et risques sont synthétisés.', 'Capabilities, references, terms and risks are summarized.', { collaboratorSlug: 'gabriel' }),
  m('finance', 'gabriel-preparer-un-appel-offres', 'Préparer un appel d’offres', 'Prepare a tender', 'Le besoin, les critères, le calendrier et les documents sont structurés.', 'Requirements, criteria, schedule and documents are structured.', { collaboratorSlug: 'gabriel' }),
  m('finance', 'gabriel-construire-une-grille-evaluation', 'Construire une grille d’évaluation fournisseurs', 'Build a supplier scorecard', 'Les critères et pondérations sont prêts à être validés par les achats.', 'Criteria and weightings are ready for procurement approval.', { collaboratorSlug: 'gabriel' }),
  m('finance', 'gabriel-analyser-les-depenses-fournisseurs', 'Analyser les dépenses fournisseurs', 'Analyze supplier spend', 'Les dépenses sont consolidées par fournisseur, catégorie et évolution.', 'Spend is consolidated by supplier, category and trend.', { collaboratorSlug: 'gabriel', modality: 'donnees' }),
  m('finance', 'gabriel-preparer-une-negociation', 'Préparer une négociation fournisseur', 'Prepare a supplier negotiation', 'Les objectifs, marges, arguments et points sensibles sont réunis.', 'Objectives, levers, arguments and sensitive points are gathered.', { collaboratorSlug: 'gabriel' }),
  m('finance', 'gabriel-evaluer-les-risques-fournisseurs', 'Évaluer les risques fournisseurs', 'Assess supplier risks', 'Les risques opérationnels, contractuels et de dépendance sont documentés.', 'Operational, contractual and dependency risks are documented.', { collaboratorSlug: 'gabriel' }),
  m('finance', 'gabriel-preparer-une-revue-fournisseur', 'Préparer une revue fournisseur', 'Prepare a supplier review', 'Une synthèse présente performance, incidents, engagements et décisions attendues.', 'A summary presents performance, incidents, commitments and expected decisions.', { collaboratorSlug: 'gabriel' }),
  m('finance', 'gabriel-cartographier-les-fournisseurs-critiques', 'Cartographier les fournisseurs critiques', 'Map critical suppliers', 'Les dépendances et fournisseurs critiques sont classés selon les critères validés.', 'Dependencies and critical suppliers are ranked against approved criteria.', { collaboratorSlug: 'gabriel' }),
]
