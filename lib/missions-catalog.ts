...
const SEEDS: Seed[] = [
  ...
  m('analyse', 'comparer-les-offres-concurrentes', 'Comparer les offres concurrentes', 'Compare competitor offers', 'Une matrice comparable des fonctionnalités, prix et positionnements.', 'A comparable matrix of features, prices and positioning.', { status: 'on-setup', collaboratorSlug: 'lea' }),
  ...
  m('analyse', 'preparer-une-etude-de-marche', 'Préparer une étude de marché', 'Prepare a market study', 'Un dossier structuré sur le marché, les clients et les principaux acteurs.', 'A structured file on the market, customers and key players.', { collaboratorSlug: 'lea' }),
  ...
  m('analyse', 'preparer-un-benchmark', 'Préparer un benchmark', 'Prepare a benchmark', 'Une comparaison structurée selon les critères définis par l’équipe.', 'A structured comparison based on the criteria set by the team.', { collaboratorSlug: 'lea' }),
  m('analyse', 'produire-une-note-de-veille', 'Produire une note de veille', 'Produce a monitoring brief', 'Une note courte présentant les faits, conséquences possibles et sources.', 'A short brief with the facts, possible consequences and sources.', { status: 'on-setup', dateAdded: '2026-08-05', collaboratorSlug: 'lea' }),
